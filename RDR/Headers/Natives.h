...
using Vehicle_t = int;
using Object_t = int;
using ObjectSet_t = int;
using PropSet_t = int;
using Pickup_t = int;
using Blip_t = int;
using Camera_t = int;
using Controller_t = int;
using Layout_t = int;
using Iterator_t = int;
using IterationSet_t = int;
using GUIWindow_t = int;
using FireHandle_t = int;
using Volume_t = int;
using Door_t = int;
using PopulationSet_t = int;
using Prompt_t = int;
using Context_t = int;
...
namespace ACTOR
{
	static void TELEPORT_ACTOR(Actor_t _Actor, const Vector3* _Position, bool _UnkFlag0, bool _UnkFlag1, bool _UnkFlag2) { Invoke<0x2D54B916, void>(_Actor, _Position, _UnkFlag0, _UnkFlag1, _UnkFlag2); }
	static void TELEPORT_ACTOR_WITH_HEADING(Actor_t _Actor, Vector2 _PositionXY, float _PositionZ, float _Heading, bool _UnkFlag0, bool _UnkFlag1, bool _UnkFlag2) { Invoke<0xE4DE507C, void>(_Actor, _PositionXY, _PositionZ, _Heading, _UnkFlag0, _UnkFlag1, _UnkFlag2); }
	static float GET_MAX_SPEED(Actor_t _Actor) { return Invoke<0x6B3A39A9, float>(_Actor); }
	static Vector3 GET_POSITION(Actor_t _Actor) { Vector3 position; Invoke<0x99BD9D6F, void>(_Actor, &position); return position; }
	static float GET_HEADING(Actor_t _Actor) { return Invoke<0x42DE39F0, float>(_Actor); }
	static int GET_ACTOR_AXIS(int _Unk0, int _Unk1, int _Unk2) { return Invoke<0x294A5549, int>(_Unk0, _Unk1, _Unk2); }
	static void SET_ACTOR_HEADING(Actor_t _Actor, float _Heading, bool _UnkFlag) { Invoke<0xECE8520B, void>(_Actor, _Heading, _UnkFlag); }
	static void SET_ACTOR_ONE_SHOT_DEATH(Actor_t _Actor, bool _Toggle) { Invoke<0xCDC686B2, void>(_Actor, _Toggle); }
	static bool GET_ACTOR_ONE_SHOT_DEATH_STATUS(Actor_t _Actor) { return Invoke<0x0912622D, bool>(_Actor); }
	...
	static bool IS_ACTOR_PLAYER(Actor_t _Actor) { return Invoke<0xB27E91E7, bool>(_Actor); }
	static bool IS_ACTOR_LOCAL_PLAYER(Actor_t _Actor) { return Invoke<0x6542CF26, bool>(_Actor); }
	static Controller_t GET_DEBUG_PADINDEX() { return Invoke<0xB114332D, int>(); }
	static Controller_t GET_PLAYER_PADINDEX(Actor_t _Actor) { return Invoke<0x524F6981, Controller_t>(_Actor); }
	static Controller_t GET_PLAYER_PADINDEX_NO_ACTOR() { return Invoke<0xCF02D1D6, Controller_t>(); }
	static void SET_PLAYER_PADINDEX(int _Unk0, int _Unk1) { Invoke<0x8F82B7D4, void>(_Unk0, _Unk1); }
	static void SET_PLAYER_CONTROL(Player_t _Player, bool _AllowAllControls, int _Flags, int _Unk3) { Invoke<0xD17AFCD8, void>(_Player, _AllowAllControls, _Flags, _Unk3); }
	static void SET_PLAYER_ENABLE_MOUNT_USE_CONTEXTS(Actor_t _Actor, bool _Value) { Invoke<0xBEEDDD54, void>(_Actor, _Value); }
	...
	static void SET_PLAYER_VEHICLE_INPUT(Player_t _Player, int _Unk1, int _Unk2, int _Unk3) { Invoke<0xE1160B04, void>(_Player, _Unk1, _Unk2, _Unk3); }
	...
	static Actor_t GET_PLAYER_ACTOR(int _PlayerId) { return Invoke<0xE8CFDD53, Actor_t>(_PlayerId); }
	static int IS_LOCAL_PLAYER(int _Unk0) { return Invoke<0x40EF1003, int>(_Unk0); }
	static bool IS_LOCAL_PLAYER_VALID(Actor_t _Actor) { return Invoke<0x0ADC17E9, bool>(_Actor); }
	static int IS_SLOT_VALID(int SlotID) { return Invoke<0xD04480FE, int>(SlotID); }
	static Actor_t GET_SLOT_ACTOR(int _SlotId) { return Invoke<0xDB9B49D8, Actor_t>(_SlotId); }
	static int GET_ACTOR_SLOT(Actor_t _Actor) { return Invoke<0xAABF3356, int>(_Actor); }
	...
	static bool IS_PLAYER_TARGETTING_ACTOR(Player_t _Player, Actor_t _Target, bool _Unk2) { return Invoke<0x87DDCA96, bool>(_Player, _Target, _Unk2); }
	static bool IS_PLAYER_DEADEYE(Actor_t _Actor) { return Invoke<0x6148423A, bool>(_Actor); }
	...
	static void SET_PLAYER_DEADEYE_POINTS(Actor_t _Actor, float _Value, bool _Unk) { Invoke<0x50D8C840, void>(_Actor, _Value, _Unk); }
	...
	static void SET_DISABLE_DEADEYE(Actor_t _Actor, bool _Value) { Invoke<0x09716951, void>(_Actor, _Value); }
	...
	static void SET_DEADEYE_MULTILOCK_ENABLE(Actor_t _Actor, bool _Value) { Invoke<0x4E6E5E78, void>(_Actor, _Value); }
	static void SET_DEADEYE_TARGETPAINT_ENABLE(Actor_t _Actor, bool _Value) { Invoke<0x5CD6E2C3, void>(_Actor, _Value); }
	static void SET_DEADEYE_INVULNERABILITY(Actor_t _Actor, bool _Value) { Invoke<0xA671FF8E, void>(_Actor, _Value); }
	static void SET_DEADEYE_DAMAGE_SCALING(Actor_t _Actor, float _Scaling) { Invoke<0x0D583DAF, void>(_Actor, _Scaling); }
	static void SET_DEADEYE_REGENERATION_RATE(Actor_t _Actor, float _Rate, bool _Unk) { Invoke<0x0415EE4C, void>(_Actor, _Rate, _Unk); }
	static void SET_DEADEYE_REGENERATION_RATE_MULTIPLIER(Actor_t _Actor, float _Multiplier) { Invoke<0x151741A2, void>(_Actor, _Multiplier); }
	static void SET_DEADEYE_TIMESCALE(Actor_t _Actor, float _TimeScale) { Invoke<0x5740CDC2, void>(_Actor, _TimeScale); }
	static void SET_INFINITE_DEADEYE(Actor_t _Actor, bool _Infinite) { Invoke<0x0C0BC04E, void>(_Actor, _Infinite); }
	...
	static void SET_ACTOR_INVULNERABILITY(Actor_t _Actor, bool _Invulnerable) { Invoke<0xE38EF526, void>(_Actor, _Invulnerable); }
	static bool GET_ACTOR_INVULNERABILITY(Actor_t _Actor) { return Invoke<0xDB39D992, bool>(_Actor); }
	static void SET_TOUGH_ACTOR(Actor_t _Actor, bool _Value) { Invoke<0x2A575132, void>(_Actor, _Value); }
	static void SET_ACTOR_UNKILLABLE(Actor_t _Actor, bool _Value) { Invoke<0x0D9A35F6, void>(_Actor, _Value); }
	...
	static void SET_ALLOW_RIDE_BY_PLAYER(Actor_t _Actor, bool _Ride) { Invoke<0xCF1A1BC5, void>(_Actor, _Ride); }
	static void SET_ALLOW_RIDE(Actor_t _Actor, bool _Ride) { Invoke<0xF83A8D2B, void>(_Actor, _Ride); }
	...
	static void SET_DEADEYE_LOCKS_ON_HEAD_ONLY(Actor_t _Actor, bool _Enabled) { Invoke<0x9375946B, void>(_Actor, _Enabled); }
	...
	static void SET_PLAYER_TO_PLAYER_DAMAGE_SCALE_FACTOR(float _Scale) { Invoke<0xA393AC4E, void>(_Scale); }
	...
	static void SET_ACTOR_STOP_UPDATE(Actor_t _Actor, bool _Toggle) { Invoke<0xC0F77310, void>(_Actor, _Toggle); }
	static bool GET_ACTOR_STOP_UPDATE(Actor_t _Actor) { return Invoke<0x4EFC58BC, bool>(_Actor); }
	...
	static void REGISTER_GPS_CURVE_OBJECTSET(ObjectSet_t _ObjectSet) { Invoke<0x1444F022, void>(_ObjectSet); }
	...
	static void SET_ACTOR_STREAMING_HIGH_PRIORITY(Actor_t _Actor, bool _Toggle) { Invoke<0x0911BA31, void>(_Actor, _Toggle); }
}
...
namespace ACTORDRAW
{
	static void SET_DRAW_ACTOR(Actor_t _Actor, bool _Draw) { Invoke<0xE6644CE5, void>(_Actor, _Draw); }
	static bool GET_DRAW_ACTOR(Actor_t _Actor) { return Invoke<0x085A9CA6, bool>(_Actor); }
}
...
namespace AI_ANIMAL
{
	...
	static void ANIMAL_ACTOR_SET_DOMESTICATION(Actor_t _Actor, bool _Domestication) { Invoke<0x58C36502, void>(_Actor, _Domestication); }
	...
	static void ANIMAL_ACTOR_SET_DOCILE(Actor_t Actor, bool Docile) { Invoke<0xABFCFF01, void>(Actor, Docile); }
}
...
namespace AI_MISC
{
	...
	static bool AI_IGNORE_ACTOR(Actor_t _Actor) { return Invoke<0x8D1FC73C, bool>(_Actor); }
	static bool AI_STOP_IGNORING_ACTOR(Actor_t _Actor) { return Invoke<0x98790639, bool>(_Actor); }
...
namespace AMBIENCE
{
	static void AMBIENCE_AUDIO_ENTITY_UPDATE_TERRITORY(const char* _Str) { Invoke<0x2A3B1045, void>(_Str); }
...
namespace AMBIENT
{
	...
	static void AMBIENT_SET_SLOPE_FILTER_PRECISE(float _Unk0, float _Unk1, float _Unk2) { Invoke<0x45190938, void>(_Unk0, _Unk1, _Unk2); }
	static void AMBIENT_ENABLE_SLOPE_FILTER_PRECISE(int _Unk0) { Invoke<0x561C9A6D, void>(_Unk0); }
	static void AMBIENT_SET_BUMP_FILTER(float _Unk0, float _Unk1, float _Unk2) { Invoke<0x912EEC43, void>(_Unk0, _Unk1, _Unk2); }
	...
	static void AMBIENT_SET_MATERIAL_IN_AREA_INCLUDES_FILTER(int _Unk0, float _Unk1, int _Unk2) { Invoke<0x9CD2B55F, void>(_Unk0, _Unk1, _Unk2); }
	static void AMBIENT_SET_MATERIAL_IN_AREA_EXCLUDES_FILTER(int _Unk0, float _Unk1, int _Unk2) { Invoke<0xBCD4979C, void>(_Unk0, _Unk1, _Unk2); }
...
namespace ANIM
{
	static float GET_ACTOR_ANIM_CURRENT_TIME(Actor_t _Actor, const char* _Animation) { return Invoke<0x8609F5E1, float>(_Actor, _Animation); }
	static bool SET_ACTOR_ANIM_CURRENT_TIME(Actor_t _Actor, int _Unk1) { return Invoke<0x8626C1A0, bool>(_Actor, _Unk1); }
	static bool IS_ACTOR_ANIM_PLAYING(Actor_t _Actor, const char* _Animation) { return Invoke<0x1ADE21EB, bool>(_Actor, _Animation); }
	static bool ACTOR_HAS_ANIM_SET(Actor_t _Actor, const char* _AnimSet) { return Invoke<0x31F5F57D, bool>(_Actor, _AnimSet); }
	static void SET_ANIMATION_OVERRIDE_SCALE(int _Unk0, int _Unk1) { Invoke<0x3E30A514, void>(_Unk0, _Unk1); }
	static bool SET_PANIM_PARAMS(Actor_t _Actor, int _Unk1, int _Unk2) { return Invoke<0x5941295A, bool>(_Actor, _Unk1, _Unk2); }
	static bool SET_PANIM_PHASE(Actor_t _Actor, int _Phase) { return Invoke<0x94431F5A, bool>(_Actor, _Phase); }
	...
	static void TOUGH_ARMOUR_SET_TUNING_REGENERATION_RATE(Actor_t _Actor, float _Rate) { Invoke<0xB3F5EE8C, void>(_Actor, _Rate); }
...
namespace AUDIO
{
	...
	static void AUDIO_SET_VEHICLE_DAMAGED(Vehicle_t _Vehicle, bool _IsDamaged) { return Invoke<0xBD0E8EBA, void>(_Vehicle, _IsDamaged); }
	...
	static void SET_AMBIENT_VOICE_NAME(Actor_t _Actor, const char* _Name) { Invoke<0xBD2EA1A1, void>(_Actor, _Name); }
	static void CLEAR_ALTERNATE_SPEECH_CONTEXT_FOR_PAIN(int _Unk0) { Invoke<0x77402033, void>(_Unk0); }
	static void CANCEL_CURRENTLY_PLAYING_AMBIENT_SPEECH(Actor_t _Actor) { Invoke<0x4DBD473B, void>(_Actor); }
	...
	static bool IS_ANY_SPEECH_PLAYING(Actor_t _Actor) { return Invoke<0x2B74A6D6, bool>(_Actor); }
	...
	static void AUDIO_TURN_OFF_PAIN_VOCALS(Actor_t _Actor) { Invoke<0x1F7F405C, void>(_Actor); }
	static void AUDIO_TURN_ON_PAIN_VOCALS(Actor_t _Actor) { Invoke<0x2B1B76E8, void>(_Actor); }
	static void AUDIO_TURN_OFF_VOCALS_EFFECTS(Actor_t _Actor) { Invoke<0xE4D418D1, void>(_Actor); }
	...
	static void AUDIO_MUSIC_ONE_SHOT(const char* _AudioName, int _Unk1, int _Unk2, int _Unk3, int _Unk4, int _Unk5) { Invoke<0x714DA5BB, void>(_AudioName, _Unk1, _Unk2, _Unk3, _Unk4, _Unk5); }
	...
	static void AUDIO_MUSIC_SET_STATE(const char* _State) { Invoke<0x789C753C, void>(_State); }
...
namespace BUILTIN
{
	...
	static bool START_NEW_SCRIPT(const char* _ScriptPath, int _StackSize) { return Invoke<0x3F166D0E, bool>(_ScriptPath, _StackSize); }
	static bool START_NEW_SCRIPT_WITH_ARGS(const char* _ScriptPath, int* _Args, int _ArgCount, int _StackSize) { return Invoke<0x4A2100E4, bool>(_ScriptPath, _Args, _ArgCount, _StackSize); }
	...
	static float VDIST(Vector2 _XY1, float _Z1, Vector2 _XY2, float _Z2) { return Invoke<0x3C08ECB7, float>(_XY1, _Z1, _XY2, _Z2); }
	static float VDIST2(Vector2 _XY1, float _Z1, Vector2 _XY2, float _Z2) { return Invoke<0xC85DEF1F, float>(_XY1, _Z1, _XY2, _Z2); }
...
namespace CAM
{
	static Camera_t GET_GAME_CAMERA() { return Invoke<0x6B7677BF, Camera_t>(); }
	static void CAMERA_RESET(int _Unk0) { Invoke<0xCE956B28, void>(_Unk0); }
	static bool CAMERA_PROBE(Vector3* Result, Vector3 Source, Vector3 Target, Actor_t Owner, int Flag) { return Invoke<0x720F2CA7, bool>(Result, Source, Target, Owner, Flag); }
	...
	static bool SET_CAMERA_FOLLOW_ACTOR(Actor_t _Actor) { return Invoke<0x8EFDFE89, bool>(_Actor); }
	static bool SET_CAMERA_FOLLOW_ACTOR_EX(Actor_t _Actor, bool _Unk1) { return Invoke<0x457A0510, bool>(_Actor, _Unk1); }
	...
	static bool IS_GAME_CAMERA_FOCUS_ENABLED() { return Invoke<0x5BD2295E, bool>(); }
	static bool IS_SWITCH_CAMERA_BUTTON_ENABLED() { return Invoke<0xAE168124, bool>(); }
	static void SET_SWITCH_CAMERA_BUTTON_ENABLED(int _Unk0) { Invoke<0x9F1F8669, void>(_Unk0); }
}

namespace CAMERA
{
	static Camera_t CREATE_CAMERA_IN_LAYOUT(Layout_t _Layout, const char* _Unk1, int _Unk2) { return Invoke<0x0B1569C5, Camera_t>(_Layout, _Unk1, _Unk2); }
	static int GET_CURRENT_CAMERA_TYPE_FROM_CHANNEL(int _Unk0) { return Invoke<0xBCC98808, int>(_Unk0); }
	static void SET_CURRENT_CAMERA_ON_CHANNEL(Camera_t _Camera, int _Unk1, int _Unk2, int _Unk3, int _Unk4, int _Unk5, int _Unk6, int _Unk7, int _Unk8, int _Unk9) { Invoke<0x3EA55678, void>(_Camera, _Unk1, _Unk2, _Unk3, _Unk4, _Unk5, _Unk6, _Unk7, _Unk8, _Unk9); }
	static void REMOVE_CAMERA_FROM_CHANNEL(Camera_t _Camera, int _Channel) { Invoke<0x423DB420, void>(_Camera, _Channel); }
	...
	static bool IS_CURRENT_CAMERA_CHANNEL_TRANSITIONING(int _Unk0) { return Invoke<0x9A4CD54B, bool>(_Unk0); }
	static bool IS_CAMERA_ACTIVE_ON_CHANNEL(int _Unk0, int _Unk1) { return Invoke<0x02BD5362, bool>(_Unk0, _Unk1); }
	static void INIT_CAMERA_FROM_GAME_CAMERA(Camera_t _Camera) { Invoke<0x2615309A, void>(_Camera); }
	static void INIT_CAMERA_FROM_CHANNEL(int _Unk0, int _Unk1) { Invoke<0x41EA7325, void>(_Unk0, _Unk1); }
	static void SET_CAMERA_POSITION(Camera_t _Camera, Vector2 _PositionXY, float _PositionZ) { Invoke<0x0B12CD8C, void>(_Camera, _PositionXY, _PositionZ); }
	static Vector3 GET_CAMERA_POSITION(Camera_t _Camera) { Vector3 position; Invoke<0x4A65F0B7, void>(_Camera, &position); return position; }
	static void SET_CAMERA_DIRECTION(Camera_t _Camera, Vector2 _DirectionXY, float _DirectionZ, bool _Unk1) { Invoke<0xA8642E5E, void>(_Camera, _DirectionXY, _DirectionZ, _Unk1); }
	static Vector3 GET_CAMERA_DIRECTION(Camera_t _Camera) { Vector3 direction; Invoke<0xBBD1078A, void>(_Camera, &direction); return direction; }
	static Vector3 GET_CAMERA_UP_VECTOR(Camera_t _Camera) { Vector3 upVector; Invoke<0x94A10ECD, void>(_Camera, &upVector); return upVector; }
	static void SET_CAMERA_FOV(Camera_t _Camera, float _FOV) { Invoke<0x57E3242D, void>(_Camera, _FOV); }
	static float GET_CAMERA_FOV(Camera_t _Camera) { return Invoke<0x7B302F36, float>(_Camera); }
	static void SET_CAMERA_ASPECT_RATIO(Camera_t _Camera, float _Value) { Invoke<0xFAEE2667, void>(_Camera, _Value); }
	static float GET_CAMERA_ASPECT_RATIO(Camera_t _Camera) { return Invoke<0xCE01609D, float>(_Camera); }
	static void SET_CAMERA_NEAR_CLIP_PLANE(Camera_t _Camera, float _Value) { Invoke<0x1D29E72A, void>(_Camera, _Value); }
	static void SET_CAMERA_FAR_CLIP_PLANE(Camera_t _Camera, float _Value) { Invoke<0xD85EF521, void>(_Camera, _Value); }
	static void SET_CAMERA_ORIENTATION(Camera_t _Camera, Vector2 _RotationXY, float _RotationZ, bool _Unk1) { Invoke<0x486F4461, void>(_Camera, _RotationXY, _RotationZ, _Unk1); }
	...
	static void SET_CAMERA_TARGET_OBJECT(Camera_t _Camera, Object_t _Object, int _Unk2) { Invoke<0xDBD1AE22, void>(_Camera, _Object, _Unk2); }
	...
	static bool IS_PROCESSING_CAMERA_SHOT_TRANSITION(int _Unk0) { return Invoke<0xDDB64AA9, bool>(_Unk0); }
	...
	static bool IS_CUTSCENEOBJECT_PAUSED(int _Unk0) { return Invoke<0xD5C66699, bool>(_Unk0); }
	...
	static bool IS_CUTSCENE_TUNER_PLAYINGBACK() { return Invoke<0xCDA6BB6C, bool>(); }
	...
	static bool IS_CAMERA_FOCUS_ACTIVE(int _Unk0) { return Invoke<0xCA8CC5CE, bool>(_Unk0); }
	static void SET_CAMERA_FOCUS_ENABLED(int _Unk0, int _Unk1) { Invoke<0x78D29E49, void>(_Unk0, _Unk1); }
	static bool IS_CAMERA_FOCUS_ENABLED(int _Unk0) { return Invoke<0x80D63DAC, bool>(_Unk0); }
...
namespace CORE
{
	static void OVERRIDE_BENCHMARK_POS(Vector3* _Position) { Invoke<0x14993D3B, void>(_Position); }
	static void OVERRIDE_BENCHMARK_DIR(Vector3* _Direction) { Invoke<0xE8AB1D5B, void>(_Direction); }
	...
	static float GET_X(Actor_t _Actor) { return Invoke<0x436CE75A, float>(_Actor); }
	static float GET_Y(Actor_t _Actor) { return Invoke<0x0B0FF6A1, float>(_Actor); }
	static float GET_Z(Actor_t _Actor) { return Invoke<0x25A02BC1, float>(_Actor); }
	...
	static Actor_t GET_TARGET_ACTOR() { return Invoke<0x0EF7427B, Actor_t>(); }
	static void GRINGO_SET_TARGET_OBJECT(int _Unk0, int _Unk1, int _Unk2) { Invoke<0x00776356, void>(_Unk0, _Unk1, _Unk2); }
	static Object_t GET_TARGET_OBJECT() { return Invoke<0x533AD3F2, Object_t>(); }
	...
	static bool IS_DEBUGKEY_DOWN(e_KeyCode _KeyCode) { return Invoke<0x358F874F, bool>(_KeyCode); }
	static bool IS_DEBUGKEY_PRESSED(e_KeyCode _KeyCode) { return Invoke<0xCBC97619, bool>(_KeyCode); }
	static bool IS_BUTTON_DOWN(Controller_t _Controller, e_Button _Button) { return Invoke<0xC3297B50, bool>(_Controller, _Button); }
	static bool IS_BUTTON_PRESSED(Controller_t _Controller, e_Button _Button) { return Invoke<0x7BCB3F15, bool>(_Controller, _Button); }
	static bool IS_BUTTON_RELEASED(Controller_t Controller, e_Button Button, int Unk1, int Unk0) { return Invoke<0xB04EB731, bool>(Controller, Button, Unk1, Unk0); }
	static float GET_ANALOG_BUTTON_VALUE(Controller_t Controller, e_Button Analog, bool Unk1) { return Invoke<0x23C9C74A, float>(Controller, Analog, Unk1); }
	...
	static float GET_STICK_X(Controller_t _Controller, bool _IsRightStick, int _Unk0) { return Invoke<0x9AAF7E28, float>(_Controller, _IsRightStick, _Unk0); }
	static float GET_STICK_Y(Controller_t _Controller, bool _IsRightStick, int _Unk0) { return Invoke<0x7C6D41A4, float>(_Controller, _IsRightStick, _Unk0); }
	...
	static bool IS_RIGHT_MOUSE_DOWN() { return Invoke<0x5598C970, bool>(); }
	static bool IS_RIGHT_MOUSE_PRESSED() { return Invoke<0xDC4B85A8, bool>(); }
	static bool IS_RIGHT_MOUSE_RELEASED() { return Invoke<0xB59B352A, bool>(); }
	static bool IS_LEFT_MOUSE_DOWN() { return Invoke<0x5AC5CE22, bool>(); }
	static bool IS_LEFT_MOUSE_PRESSED() { return Invoke<0x7D4535A1, bool>(); }
	...
	static float GET_MOUSE_DX() { return Invoke<0x88F07597, float>(); }
	static float GET_MOUSE_DY() { return Invoke<0x3A62D87D, float>(); }
	...
	static const char* SAVE_MANAGER_SET_SAVE_VERSION(const char* _Unk0) { return Invoke<0x8E867DDD, const char*>(_Unk0); }
	static const char* SAVE_MANAGER_SET_SAVE_VERSION_FOR_TYPE(int _Unk0, int _Unk1) { return Invoke<0x6E79F939, const char*>(_Unk0, _Unk1); }
	...
	static bool ____IS_DEV_BUILD() { return Invoke<0x6D9AA768, bool>(); }
	...
	static const char* GET_COMMANDLINE_START_POS(int _Unk0, int _Unk1) { return Invoke<0x6CD7DCE1, const char*>(_Unk0, _Unk1); }
	...
	static bool LAUNCH_NEW_SCRIPT(const char* _ScriptPath, int _Unk0) { return Invoke<0x85A30503, bool>(_ScriptPath, _Unk0); }
...
namespace CURVES
{
	static void ENABLE_CURVE(const char* _CurveRef, bool _Enable) { Invoke<0x0C46DAB3, void>(_CurveRef, _Enable); }
...
namespace DECORATOR
{
	...
	static int DECOR_SET_BOOL(Object_t _Object, const char* _DecorName, bool _Set) { return Invoke<0x8E101F5C, int>(_Object, _DecorName, _Set); }
	static int DECOR_SET_FLOAT(Object_t _Object, const char* _DecorName, float _Value) { return Invoke<0xBC7BD5CB, int>(_Object, _DecorName, _Value); }
	static int DECOR_SET_INT(Object_t _Object, const char* _DecorName, int _Value) { return Invoke<0xDB718B21, int>(_Object, _DecorName, _Value); }
	...
	static int DECOR_CHECK_STRING(Object_t decor, const char* EventType, const char* EventName) { return Invoke<0xEDF99C77, int>(decor, EventType, EventName); }
	static int DECOR_GET_STRING_HASH(int _Unk0, int _Unk1) { return Invoke<0x6A0FE2A0, int>(_Unk0, _Unk1); }
	static bool DECOR_GET_BOOL(Object_t _Object, const char* _DecorName) { return Invoke<0xDBCE51E0, bool>(_Object, _DecorName); }
	static float DECOR_GET_FLOAT(Object_t _Object, const char* _DecorName) { return Invoke<0x8DE5382F, float>(_Object, _DecorName); }
	static int DECOR_GET_INT(Object_t _Object, const char* _DecorName) { return Invoke<0xDDDE59B5, int>(_Object, _DecorName); }
	...
	static bool DECOR_CHECK_EXIST(Object_t _Object, const char* _DecorName) { return Invoke<0xA0773F5C, bool>(_Object, _DecorName); }
	static bool DECOR_REMOVE(Object_t _Object, const char* _DecorName) { return Invoke<0xE0E2640B, bool>(_Object, _DecorName); }
	static int DECOR_REMOVE_ALL(int _Unk0) { return Invoke<0xFDB9E349, int>(_Unk0); }
}

namespace DLC
{
	static void DLC_PRE_INIT_CONTENT() { Invoke<0x0728B211, void>(); }
	static void DLC_INIT_CONTENT() { Invoke<0xEC86DB0E, void>(); }
	static void DLC_PREINITIALIZE_FRAGMENT_STUBS(const char* _Unk0) { Invoke<0x57D9950B, void>(_Unk0); }
	static void DLC_INIT_STRINGTABLE_STREAMABLES(const char* _Unk0, int _Unk1) { Invoke<0xF4D0807E, void>(_Unk0, _Unk1); }
	static bool DLC_IS_CONTENT_PURCHASED_FLAGS(int _Unk0) { return Invoke<0x853F71F6, bool>(_Unk0); }
	static void DLC_UNMOUNT_PACK() { Invoke<0x2F78AEFA, void>(); }
}

namespace DOOR
{
	static Door_t FIND_NEAREST_DOOR(Vector3* _Position, float _Radius) { return Invoke<0x9CB5372B, Door_t>(_Position, _Radius); }
	static Door_t GET_DOOR_FROM_OBJECT(Object_t _Object) { return Invoke<0x9CE0AA24, Door_t>(_Object); }
	static bool IS_DOOR_VALID(Door_t _Door) { return Invoke<0x7F0F079B, bool>(_Door); }
	static bool IS_DOOR_LOCKED(Door_t _Door) { return Invoke<0x19FB9518, bool>(_Door); }
	static void SET_DOOR_LOCK(Door_t _Door, bool _Locked) { Invoke<0x184924E2, void>(_Door, _Locked); }
	static bool IS_DOOR_CLOSED(Door_t _Door) { return Invoke<0x48659CD7, bool>(_Door); }
	static bool IS_DOOR_OPENED(Door_t _Door) { return Invoke<0x211DD9D2, bool>(_Door); }
	static bool IS_DOOR_OPENING(Door_t _Door) { return Invoke<0x52BB0836, bool>(_Door); }
	static bool IS_DOOR_CLOSING(Door_t _Door) { return Invoke<0xCBA9F32C, bool>(_Door); }
	static void SET_DOOR_AUTO_CLOSE(Door_t _Door, bool _AutoClose) { Invoke<0xD3300956, void>(_Door, _AutoClose); }
	...
	static void OPEN_DOOR_DIRECTION(Door_t _Door, bool _ClockWise) { Invoke<0xAACB4435, void>(_Door, _ClockWise); }
...
namespace ENTITY
{
	static bool IS_ACTOR_VALID(Actor_t _Actor) { return Invoke<0xBA6C3E92, bool>(_Actor); }
	...
	static Vector3 GET_ACTOR_VELOCITY(Actor_t _Actor) { Vector3 velocity; Invoke<0xAD6AF65C, bool>(_Actor, &velocity); return velocity; }
	...
	static e_Species GET_ACTORENUM_SPECIES(e_ActorModel _Model) { return Invoke<0x6AC01FCB, e_Species>(_Model); }
	...
	static void SET_ACTOR_IS_THE_BEASTMASTER(Actor_t _Actor, bool _Value) { Invoke<0x8392855D, void>(_Actor, _Value); }
	...
	static bool IS_PLAYER_WEAPON_ZOOMED(Actor_t _Actor) { return Invoke<0x0A842786, bool>(_Actor); }
	static bool IS_ACTOR_ANIMAL(Actor_t Actor) { return Invoke<0x8E0769F3, bool>(Actor); }
	static bool IS_ACTOR_CROUCHING(Actor_t _Actor) { return Invoke<0xF6BF4242, bool>(_Actor); }
	static int IS_ACTOR_FLYING(int _Unk0) { return Invoke<0x25670955, int>(_Unk0); }
	static bool IS_ACTOR_HUMAN(Actor_t _Actor) { return Invoke<0x882C84DC, bool>(_Actor); }
	static int IS_ACTOR_JUMPING(int _Unk0) { return Invoke<0xDFF96719, int>(_Unk0); }
	static bool IS_ACTOR_SHOOTING(Actor_t _Actor) { return Invoke<0x4B441DC4, bool>(_Actor); }
	static int IS_ACTOR_BLINDFIRING(int _Unk0) { return Invoke<0x6396ABB7, int>(_Unk0); }
	static bool IS_ACTOR_RELOADING(Actor_t _Actor) { return Invoke<0x39C518DB, bool>(_Actor); }
	static bool IS_ACTOR_THROWING(Actor_t _Actor) { return Invoke<0x886BD8AD, bool>(_Actor); }
	...
	static void SUSPEND_MOVER(Actor_t _Actor) { Invoke<0x017D270E, void>(_Actor); }
	static void ENABLE_MOVER(Actor_t _Actor) { Invoke<0xE29F0A39, void>(_Actor); }
	static void SET_MOVER_FROZEN(Actor_t _Actor, bool _Value) { Invoke<0x13E6B5EE, void>(_Actor, _Value); }
	static bool IS_MOVER_FROZEN(Actor_t _Actor) { return Invoke<0x9C12BD5A, bool>(_Actor); }
	...
	static bool IS_ACTOR_IN_WATER(Actor_t _Actor) { return Invoke<0x7D65D9C7, bool>(_Actor); }
	...
	static bool IS_ACTOR_RIDEABLE(Actor_t _Actor) { return Invoke<0x8842C62D, bool>(_Actor); }
	static void SET_ACTOR_RIDEABLE(Actor_t Actor, bool Rideable) { Invoke<0x19F3CB6B, void>(Actor, Rideable); }
	...
	static bool ACTOR_RESET_ANIMS(int _Unk0, int _Unk1) { return Invoke<0x35D8B4AA, bool>(_Unk0, _Unk1); }
	...
	static void ACTOR_ENABLE_VARIABLE_MESH(Actor_t _Actor, int _VariableMesh, bool _Enabled) { Invoke<0xDA2F6203, void>(_Actor, _VariableMesh, _Enabled); }
	static bool ACTOR_IS_VARIABLE_MESH_ENABLED(Actor_t _Actor, int _Id) { return Invoke<0x5DE31288, bool>(_Actor, _Id); }
	...
	static void SET_ACTOR_VISION_FIELD_OF_VIEW(Actor_t _Actor, int _Value) { Invoke<0xF8F3FE84, void>(_Actor, _Value); }
	...
	static void SET_ACTOR_MAX_SPEED(Actor_t _Actor, int _Speed) { Invoke<0x9CB01B27, void>(_Actor, _Speed); }
	static void SET_ACTOR_MAX_SPEED_ABSOLUTE(Actor_t _Actor, int _Speed) { Invoke<0x950B8870, void>(_Actor, _Speed); }
	...
	static void SET_ACTOR_SPEED(Actor_t _Actor, float _Speed) { Invoke<0x09D78931, void>(_Actor, _Speed); }
	static void CLEAR_LAST_ATTACK(int _Unk0) { Invoke<0x68D4A021, void>(_Unk0); }
	static Actor_t GET_LAST_ATTACK_TARGET(Actor_t actor) { return Invoke<0xEB40C2FC, Actor_t>(actor); }
	...
	static void SET_ACTOR_IS_AMBIENT(Actor_t _Actor, bool _Toggle) { Invoke<0x4CB24141, void>(_Actor, _Toggle); }
...
namespace EVENT
{
	...
	static Object_t GET_EVENT_FROM_OBJECT(Object_t _Unk0) { return Invoke<0x184BD1BC, Object_t>(_Unk0); }
	...
	static Layout_t GET_EVENT_LAYOUT() { return Invoke<0xD938B523, Layout_t>(); }
	...
	static IterationSet_t _GET_ITERATION_SET(int SetId) { return Invoke<0xBC58F1EA, IterationSet_t>(SetId); }
...
namespace EXPLOSION
{
	static void _CREATE_EXPLOSION(Vector3* _Position, const char* _ExplosionName, Actor_t _Owner, Vector3* _DamageSphere, bool _Unk) { Invoke<0xE7023D23, void>(_Position, _ExplosionName, _Owner, _DamageSphere, _Unk); }
...
namespace FACTION
{
	...
	static e_Faction GET_ACTOR_FACTION(Actor_t _Actor) { return Invoke<0x52E2A611, e_Faction>(_Actor); }
	static void SET_ACTOR_FACTION(Actor_t _Actor, e_Faction _Faction) { Invoke<0xCC63951A, void>(_Actor, _Faction); }
	static bool IS_FACTION_VALID(e_Faction _Faction) { return Invoke<0x5E2F718D, bool>(_Faction); }
	static void VERIFY_FACTION_ENUM(const char* _FactionName, e_Faction _Faction) { Invoke<0x22424394, void>(_FactionName, _Faction); }
...
namespace FX
{
	...
	static void BURN_ACTOR(Actor_t _Actor, float _Unk1, int _Unk2) { Invoke<0xA257C16D, void>(_Actor, _Unk1, _Unk2); }
	static void LIMIT_BLOOD_ON_ACTOR(int _Unk0, int _Unk1) { Invoke<0x3627F773, void>(_Unk0, _Unk1); }
	static void LOAD_PTFX_DLC_ASSETS(const char* _PackName) { Invoke<0x48123591, void>(_PackName); }
...
namespace GAME
{
	...
	static void SET_PAUSE_SCRIPT(const char* _ScriptPath) { Invoke<0x9B71351C, void>(_ScriptPath); }
	static void ENABLE_USE_CONTEXTS(bool _Value) { Invoke<0xFEA58D57, void>(_Value); }
	static bool ARE_USE_CONTEXTS_ENABLED() { return Invoke<0x2ADA3DD4, bool>(); }
	static bool IS_SCRIPT_USE_CONTEXT_VALID(Context_t _Context) { return Invoke<0x115CD0CC, bool>(_Context); }
	static int ADD_SCRIPT_USE_CONTEXT_IN_VOLUME(const char* _GXTEntry, Volume_t _Volume, int _Unk2, const char* _InputString, const char* _Unk4, const char* _Unk5, const char* _Unk6, const char* _Unk7, int _Unk8, const char* _HUDSound) { return Invoke<0x039E7F1D, int>(_GXTEntry, _Volume, _Unk2, _InputString, _Unk4, _Unk5, _Unk6, _Unk7, _Unk8, _HUDSound); }
	static int ADD_SCRIPT_USE_CONTEXT(const char* _GXTEntry, int _Unk1, const char* _InputString, const char* _Unk3, const char* _Unk4, const char* _Unk5, const char* _Unk6, int _Unk7, const char* _HUDSound) { return Invoke<0xD7591B0E, int>(_GXTEntry, _Unk1, _InputString, _Unk3, _Unk4, _Unk5, _Unk6, _Unk7, _HUDSound); }
	static int ADD_SCRIPT_USE_CONTEXT_STICK(const char* _GXTEntry, int _Unk1, const char* _InputString, const char* _Unk3, const char* _Unk4, const char* _Unk5, const char* _Unk6, int _Unk7, const char* _HUDSound) { return Invoke<0xF48F8F09, int>(_GXTEntry, _Unk1, _InputString, _Unk3, _Unk4, _Unk5, _Unk6, _Unk7, _HUDSound); }
	static bool IS_SCRIPT_USE_CONTEXT_PRESSED(Context_t _Context) { return Invoke<0x45C1C061, bool>(_Context); }
	static bool WAS_SCRIPT_USE_CONTEXT_EVER_PRESSED(Context_t _Context) { return Invoke<0x971559CA, bool>(_Context); }
	static void SET_USE_CONTEXT_TEXT(Context_t _Context, const char* _GXTEntry, const char* _Unk2, const char* _Unk3, int _Unk4, int _Unk5) { Invoke<0x3ECD8FEE, void>(_Context, _GXTEntry, _Unk2, _Unk3, _Unk4, _Unk5); }
	static void RELEASE_SCRIPT_USE_CONTEXT(Context_t _Context) { Invoke<0x4F52CB58, void>(_Context); }
...
namespace GRAVESTONE
{
	...
	static Object_t CREATE_GRAVESTONE_TEXT_IN_LAYOUT(Object_t _Object, const char* _LayoutName, const char* _GXTEntry, int _Unk0, int _Unk1, int _RGBHex) { return Invoke<0xAEC955F8, Object_t>(_Object, _LayoutName, _GXTEntry, _Unk0, _Unk1, _RGBHex); }
	static Object_t CREATE_WANTEDPOSTER_TEXT(int _Unk0, int _Unk1, int _Unk2, int _Unk3, int _Unk4, int _Unk5, int _Unk6, int _Unk7, int _Unk8, int _Unk9) { return Invoke<0x211DE185, Object_t>(_Unk0, _Unk1, _Unk2, _Unk3, _Unk4, _Unk5, _Unk6, _Unk7, _Unk8, _Unk9); }
	static Object_t CREATE_MP_TEXT(Object_t _Object, const char* _LayoutName, const char* _GXTEntry, Vector2 _PositionXY, float _PositionZ, Vector2 _RotationXY, float _RotationZ, int _RGBHex) { return Invoke<0x5BF5A39C, Object_t>(_Object, _LayoutName, _GXTEntry, _PositionXY, _PositionZ, _RotationXY, _RotationZ, _RGBHex); }
}
...
namespace GRINGO
{
	...
	static bool GRINGO_PLAY_ANIM_ON_ACTOR(int _Unk0, int _Unk1, int _Unk2) { return Invoke<0xE18BCD70, bool>(_Unk0, _Unk1, _Unk2); }
...
namespace GUI
{
	static int GUI_MAKE_WINDOW(GUIWindow_t Parent, int _Unk1, const char* WindowName, const char* _Unk3) { return Invoke<0xA20246AB, int>(Parent, _Unk1, WindowName, _Unk3); }
	...
	static GUIWindow_t GUI_WINDOWS_WITH_VALUES(int GUIHandle, const char* WindowName) { return Invoke<0xF6207DF5, GUIWindow_t>(GUIHandle, WindowName); }
	...
	static GUIWindow_t GUI_MAIN_WINDOW() { return Invoke<0x5405B8AA, GUIWindow_t>(); }
...
namespace HEALTH
{
	static Actor_t GET_LAST_ATTACKER(Actor_t _Actor) { return Invoke<0x2C0F211D, Actor_t>(_Actor); }
	static int GET_LAST_HIT_TIME(Actor_t _Actor) { return Invoke<0x3A207AF2, int>(_Actor); }
	static e_WeaponModel GET_LAST_HIT_WEAPON(Actor_t _Actor) { return Invoke<0x07B7AA6B, e_WeaponModel>(_Actor); }
	static int GET_LAST_HIT_FLAGS(Actor_t _Actor) { return Invoke<0x08308EBA, int>(_Actor); }
	static int GET_LAST_DAMAGE(Actor_t _Actor) { return Invoke<0x45556269, int>(_Actor); }
	static bool GET_LAST_HIT_ZONE(Actor_t _Actor, int* _Out) { return Invoke<0x855F9A3B, bool>(_Actor, _Out); }
	...
	static void CLEAR_LAST_HIT(Actor_t _Actor) { Invoke<0x8D696237, void>(_Actor); }
	static void KILL_ACTOR(Actor_t _Actor) { Invoke<0x8B08ECA2, void>(_Actor); }
	static void KILL_ACTOR_WITH_KILLER(Actor_t _Actor, Actor_t _Killer) { Invoke<0x6085F7AC, void>(_Actor, _Killer); }
	static bool IS_ACTOR_ALIVE(Actor_t _Actor) { return Invoke<0x2F232639, bool>(_Actor); }
	static bool IS_ACTOR_DEAD(Actor_t _Actor) { return Invoke<0x0D798FFE, bool>(_Actor); }
	static bool IS_ACTOR_RAGDOLL(Actor_t _Actor) { return Invoke<0x3918D335, bool>(_Actor); }
	static void SET_ACTOR_HEALTH(Actor_t _Actor, float _Health) { Invoke<0xFA090024, void>(_Actor, _Health); }
	static float GET_ACTOR_HEALTH(Actor_t _Actor) { return Invoke<0xF246F15D, float>(_Actor); }
	static float GET_ACTOR_MAX_HEALTH(Actor_t _Actor) { return Invoke<0xB69A84AF, float>(_Actor); }
	static void SET_ACTOR_MAX_HEALTH(Actor_t _Actor, float _MaxHealth) { Invoke<0x165BD4C5, void>(_Actor, _MaxHealth); }
	static int _ACTOR_HAS_KO_POINTS(int _Unk0) { return Invoke<0x7A207FFE, int>(_Unk0); }
	static void SET_ACTOR_KO_POINTS(Actor_t _Actor, int _Unk1) { Invoke<0x3A2D7759, void>(_Actor, _Unk1); }
	static int GET_ACTOR_KO_POINTS(Actor_t _Actor) { return Invoke<0x44787A58, int>(_Actor); }
	static int GET_ACTOR_MAX_KO_POINTS(Actor_t _Actor) { return Invoke<0xAFC96669, int>(_Actor); }
	static void SET_ACTOR_KNOCKOUTTIME(Actor_t _Actor, float _Time) { Invoke<0x4EEC6628, void>(_Actor, _Time); }
	static void SET_ACTOR_KNOCKOUTTIME_DEFAULT(Actor_t _Actor, float _Time) { Invoke<0x479B997B, void>(_Actor, _Time); }
	static bool IS_ACTOR_DRUNK(Actor_t _Actor) { return Invoke<0xFF07D58C, bool>(_Actor); }
	static void SET_ACTOR_DRUNK(Actor_t _Actor, bool _IsDrunk) { Invoke<0x9F57742C, void>(_Actor, _IsDrunk); }
	static void SET_ACTOR_PASSED_OUT(Actor_t _Actor, bool _Toggle) { Invoke<0x2A9FD09F, void>(_Actor, _Toggle); }
	static void SET_ACTOR_HANGING_FROM_NOOSE(Actor_t _Actor, int _Unk1) { Invoke<0x5262C0F7, void>(_Actor, _Unk1); }
...
namespace HUD
{
	static void UI_SET_PROMPT_STRING(Prompt_t _Prompt, const char* _PromptString) { Invoke<0xFA0CF208, void>(_Prompt, _PromptString); }
	static void UI_SET_PROMPT_ICON(Prompt_t _Prompt, int _PromptIcon) { Invoke<0xA77E0DDF, void>(_Prompt, _PromptIcon); }
	static void UI_SET_PROMPT_ICON_STRING(Prompt_t _Prompt, const char* _IconString) { Invoke<0x247348C5, void>(_Prompt, _IconString); }
	static void UI_HIDE_PROMPT(Prompt_t _Prompt) { Invoke<0x545EC471, void>(_Prompt); }
	static int FLASH_SET_BOOL(const char* _ScaleformName, const char* _ScaleformVarName, bool _Value) { return Invoke<0x34F03EC7, int>(_ScaleformName, _ScaleformVarName, _Value); }
	static int FLASH_SET_INT(const char* _ScaleformName, const char* _ScaleformVarName, int _Value) { return Invoke<0x4778A580, int>(_ScaleformName, _ScaleformVarName, _Value); }
	static int FLASH_SET_FLOAT(const char* _ScaleformName, const char* _ScaleformVarName, float _Value) { return Invoke<0xDF024C94, int>(_ScaleformName, _ScaleformVarName, _Value); }
	static int FLASH_SET_ARRAY_INT(const char* _ScaleformName, const char* _ScaleformVarName, int _Value, int _Unk3) { return Invoke<0x8A2A1A51, int>(_ScaleformName, _ScaleformVarName, _Value, _Unk3); }
	static int FLASH_SET_STRING(const char* _ScaleformName, const char* _ScaleformVarName, int _Unk2, int _Unk3) { return Invoke<0x9E31EEA7, int>(_ScaleformName, _ScaleformVarName, _Unk2, _Unk3); }
	static int FLASH_SET_ARRAY_STRING(const char* _ScaleformName, const char* _ScaleformVarName, const char* _PromptString, Prompt_t _Prompt, int _Unk4) { return Invoke<0x35CDFDC5, int>(_ScaleformName, _ScaleformVarName, _PromptString, _Prompt, _Unk4); }
	static bool FLASH_GET_BOOL(const char* _ScaleformName, const char* _ScaleformVarName) { return Invoke<0xFA266B15, bool>(_ScaleformName, _ScaleformVarName); }
	static int FLASH_GET_INT(const char* _ScaleformName, const char* _ScaleformVarName) { return Invoke<0x03568B83, int>(_ScaleformName, _ScaleformVarName); }
	static float FLASH_GET_FLOAT(const char* _ScaleformName, const char* _ScaleformVarName) { return Invoke<0xA332ACE3, float>(_ScaleformName, _ScaleformVarName); }
	...
	static Blip_t ADD_BLIP_FOR_ACTOR(Actor_t _Actor, e_BlipIcon _BlipIcon, float _MinDistance, int _Priority, int _Unk2) { return Invoke<0xEFB9362F, Blip_t>(_Actor, _BlipIcon, _MinDistance, _Priority, _Unk2); }
	static Blip_t ADD_BLIP_FOR_OBJECT(Object_t _Object, e_BlipIcon _BlipIcon, float _MinDistance, int _Priority, int _Unk2) { return Invoke<0x0E5372EC, Blip_t>(_Object, _BlipIcon, _MinDistance, _Priority, _Unk2); }
	static Blip_t ADD_BLIP_FOR_COORD(Vector3* _Position, e_BlipIcon _BlipIcon, float _MinDistance, int _Priority, int _Unk2) { return Invoke<0xC6F43D0E, Blip_t>(_Position, _BlipIcon, _MinDistance, _Priority, _Unk2); }
	static void CHANGE_BLIP_ICON(Blip_t _Blip, e_BlipIcon _BlipIcon) { Invoke<0xABD125F6, void>(_Blip, _BlipIcon); }
	static void SET_BLIP_POS(Blip_t _Blip, Vector3* _Position) { Invoke<0xB2EAF8DD, void>(_Blip, _Position); }
	static void SET_BLIP_SCALE(Blip_t _Blip, float _Scale) { Invoke<0x1E6EC434, void>(_Blip, _Scale); }
	static void SET_BLIP_COLOR(Blip_t _Blip, float _R, float _G, float _B, float _A) { Invoke<0xA2B8A736, void>(_Blip, _R, _G, _B, _A); }
	static void SET_BLIP_PRIORITY(Blip_t _Blip, int _Priority) { Invoke<0xCE87DA6F, void>(_Blip, _Priority); }
	static void SET_BLIP_BLINK(Blip_t _Blip, int _Unk1, int _Unk2, int _Unk3) { Invoke<0x04B8C8C6, void>(_Blip, _Unk1, _Unk2, _Unk3); }
	static void SET_BLIP_FLAG(Blip_t _Blip, int _Unk1, int _Unk2) { Invoke<0xA9A01C70, void>(_Blip, _Unk1, _Unk2); }
	static void SET_BLIP_VISIBLE(Blip_t _Blip, bool _Visible) { Invoke<0x9318D3D2, void>(_Blip, _Visible); }
	static bool IS_BLIP_VISIBLE(Blip_t _Blip) { return Invoke<0x1E7A6623, bool>(_Blip); }
	static bool IS_BLIP_VALID(Blip_t _Blip) { return Invoke<0xDCC10BA9, bool>(_Blip); }
	static void REMOVE_BLIP(Blip_t _Blip) { Invoke<0xD8C3C1CD, void>(_Blip); }
	static Blip_t GET_BLIP_ON_ACTOR(Actor_t _Actor) { return Invoke<0x1449EE9E, Blip_t>(_Actor); }
	static Blip_t GET_BLIP_ON_OBJECT(Object_t Obj) { return Invoke<0xE3E30992, Blip_t>(Obj); }
	static e_BlipIcon GET_BLIP_ICON(Blip_t _Blip) { return Invoke<0xEE4F4B7D, e_BlipIcon>(_Blip); }
	...
	static void SET_HUD_MAP_SCALE_WALK(float _Scale) { Invoke<0x7FF20D84, void>(_Scale); }
	static void SET_HUD_MAP_SCALE_DRIVE(float _Scale) { Invoke<0x364450B1, void>(_Scale); }
	...
	static void SET_BLIP_HUDMAP_ONLY(Blip_t _Blip, bool _Toggle) { Invoke<0x1E98AFEC, void>(_Blip, _Toggle); }
	static void SET_BLIP_PAUSEMAP_ONLY(Blip_t _Blip, bool _Toggle) { Invoke<0xFF3DB575, void>(_Blip, _Toggle); }
	...
	static void SET_BLIP_MAX_DISTANCE(Blip_t _Blip, float _MaxDistance) { Invoke<0xCE79F8E2, void>(_Blip, _MaxDistance); }
	static void SET_BLIP_MIN_DISTANCE(Blip_t _Blip, float _MinDistance) { Invoke<0xFBA76D7E, void>(_Blip, _MinDistance); }
	static void _SET_BLIP_HEIGHT_ENABLED(Blip_t _Blip, bool _Enabled) { Invoke<0x6077F3AE, void>(_Blip, _Enabled); }
	static void SET_BLIP_NAME(Blip_t _Blip, const char* _GXTEntry) { Invoke<0xDC249B12, void>(_Blip, _GXTEntry); }
	...
	static void SET_REGION_VISITED(int _Region, bool _Visited) { Invoke<0x970AC1F7, void>(_Region, _Visited); }
	static bool IS_HUD_MAP_DRAW_ENABLED() { return Invoke<0xF5B7B208, bool>(); }
	static void SET_HUD_MAP_DRAW_ENABLED(bool _Enable) { Invoke<0xA094152A, void>(_Enable); }
	static void SET_HUD_MAP_DRAW_ENABLED_TIMED(int _Unk0, int _Unk1, int _Unk2) { Invoke<0x0DFF578A, void>(_Unk0, _Unk1, _Unk2); }
	static bool IS_HUD_MAP_VISIBLE() { return Invoke<0xCE043618, bool>(); }
	static void SET_RADAR_TILES_VISIBLE(bool _Enable) { Invoke<0x48DB367D, void>(_Enable); }
	...
	static bool IS_STAT_MESSAGE_SHOWING() { return Invoke<0x919142BE, bool>(); }
	...
	static void HUD_SET_FADE_COLOR(float _R, float _G, float _B, float _A) { Invoke<0x4DA5F502, void>(_R, _G, _B, _A); }
	static void HUD_FADE_OUT(float _Unk0, float _Unk1, int _Unk2) { Invoke<0x52963366, void>(_Unk0, _Unk1, _Unk2); }
	static void HUD_FADE_TO_LOADING_SCREEN() { Invoke<0xB0B4296A, void>(); }
	static void HUD_FADE_IN(float _Unk0, float _Unk1) { Invoke<0xF90F6C51, void>(_Unk0, _Unk1); }
	static void HUD_FADE_IN_NOW(float _Unk0, float _Unk1) { Invoke<0x7E4A92CF, void>(_Unk0, _Unk1); }
	...
	static void FLASH_INTRO_FADE_LOGO(bool _Fade) { Invoke<0xBB2EABF9, void>(_Fade); }
	static void FLASH_INTRO_FADE_PRESS_START(bool _Fade) { Invoke<0x9E6D7105, void>(_Fade); }
	static bool FLASH_INTRO_ARE_LEGALS_COMPLETED() { return Invoke<0x82A290D4, bool>(); }
	static void MOVIE_PLAYER_STOP_MOVIE() { Invoke<0x0C197810, void>(); }
	static int UI_IS_SHOWING_DIALOG() { return Invoke<0xC64DF45D, int>(); }
	static void UI_TRANSITION_TO(const char* _UILayer) { Invoke<0xD0F2D2B6, void>(_UILayer); }
	static int UI_GET_REBOOT_REASON(int _Unk0) { return Invoke<0x111554E2, int>(_Unk0); }
	static void UI_SEND_EVENT(const char* _Event) { Invoke<0xB58825F5, void>(_Event); }
	static void UI_ENTER(const char* _UILayer) { Invoke<0x594F2657, void>(_UILayer); }
	static void _0x8A8BDCF9(bool _Enable) { Invoke<0x8A8BDCF9, void>(_Enable); }
	...
	static void SET_GPS_PATH(int _Type, int _Unk1, ObjectSet_t _ObjectSet, float _Unk3, float _Unk4, float _Unk5, float _Unk6, const Vector3* _DestCoords, bool _Unk8) { Invoke<0xD82F910C, void>(_Type, _Unk1, _ObjectSet, _Unk3, _Unk4, _Unk5, _Unk6, _DestCoords, _Unk8); }
	static bool IS_GPS_RECOMPUTE(int _Type) { return Invoke<0xAA322DFC, bool>(_Type); }
	static void CLEAR_GPS_PATH(int _Type) { Invoke<0xD077D8B6, void>(_Type); }
	...
	static bool FIND_TRAFFIC_PATH(Layout_t _Layout, ObjectSet_t _ObjectSet, const Vector3* _SrcCoords, const Vector3* _DestCoords, int _Unk4, int* _Unk5) { return Invoke<0xA5BDC21D, bool>(_Layout, _ObjectSet, _SrcCoords, _DestCoords, _Unk4, _Unk5); }
...
namespace INTERSECTION
{
	...
	static bool FIND_GROUND_INTERSECTION(Vector3* _InputCoords, float _StartHeight, Vector3* _OutputCoords, int* _Unk3) { return Invoke<0x6AD8EEAF, bool>(_InputCoords, _StartHeight, _OutputCoords, _Unk3); }
	static bool FIND_GROUND_INTERSECTION_WITH_MATERIAL(Vector3* _InputCoords, float _StartHeight, Vector3* _OutputCoords, int* _Unk3, int* _Unk4) { return Invoke<0x77964B0C, bool>(_InputCoords, _StartHeight, _OutputCoords, _Unk3, _Unk4); }
...
namespace INVENTORY
{
	static int ADD_ITEM(const char* ItemName, Actor_t Actor, int Unk1) { return Invoke<0xBAA5D41B, int>(ItemName, Actor, Unk1); }
	...
	static void READY_ITEM(const char* ItemName, Actor_t Actor) { Invoke<0x2B00A643, void>(ItemName, Actor); }
	...
	static void GIVE_WEAPON_TO_ACTOR(Actor_t _Actor, e_WeaponModel _WeaponModel, int _Unk, bool _Notify, bool _IsHidden) { Invoke<0x6AA0EAF2, void>(_Actor, _WeaponModel, _Unk, _Notify, _IsHidden); }
	static void ACTOR_SET_NEXT_WEAPON(int _Unk0, int _Unk1) { Invoke<0xBFD6D55F, void>(_Unk0, _Unk1); }
	static void ACTOR_PUT_WEAPON_IN_HAND(Actor_t _Actor, e_WeaponModel _WeaponModel, bool _InHand) { Invoke<0x8F4B473D, void>(_Actor, _WeaponModel, _InHand); }
	...
	static void DELETE_WEAPON_FROM_ACTOR(Actor_t _Actor, e_WeaponModel _WeaponModel) { Invoke<0xCB017277, void>(_Actor, _WeaponModel); }
	static e_WeaponModel GET_WEAPON_EQUIPPED(Actor_t _Actor, int _WeaponWheelIndex) { return Invoke<0x42C0FAAA, e_WeaponModel>(_Actor, _WeaponWheelIndex); }
	static int GET_WEAPON_IS_EXTERNALLY_CREATED(int _Unk0, int _Unk1) { return Invoke<0x6262DC5E, int>(_Unk0, _Unk1); }
	static e_WeaponModel GET_WEAPON_IN_HAND(Actor_t _Actor) { return Invoke<0xA4B2016D, e_WeaponModel>(_Actor); }
	...
	static void EQUIP_ACCESSORY(Actor_t _Actor, e_AccessoryModel _AccessoryModel, int _Unk2) { Invoke<0x5A80659D, void>(_Actor, _AccessoryModel, _Unk2); }
	static void DEEQUIP_ACCESSORY(Actor_t _Actor, e_AccessoryModel _AccessoryModel) { Invoke<0xF7696B8B, void>(_Actor, _AccessoryModel); }
	static bool HAS_ACCESSORY_ENUM(Actor_t _Actor, e_AccessoryModel _AccessoryModel) { return Invoke<0x9B958A25, bool>(_Actor, _AccessoryModel); }
	static bool IS_ACCESSORY_EQUIPPPED(Actor_t _Actor, int _Accessory) { return Invoke<0xE094DB31, bool>(_Actor, _Accessory); }
	static int DROP_ACCESSORY_ENUM(int _Unk0, int _Unk1) { return Invoke<0x7FDDF876, int>(_Unk0, _Unk1); }
	static void ACTOR_SET_WEAPON_AMMO(Actor_t _Actor, e_WeaponModel _WeaponModel, float _AmmoCount) { Invoke<0x8266C617, void>(_Actor, _WeaponModel, _AmmoCount); }
	static void ACTOR_SET_WEAPON_AMMO_BY_CRC(int _Unk0, int _Unk1, float _Unk2) { Invoke<0xB008EF49, void>(_Unk0, _Unk1, _Unk2); }
	static bool ACTOR_HAS_WEAPON(Actor_t _Actor, e_WeaponModel _WeaponModel) { return Invoke<0x0D47CFBD, bool>(_Actor, _WeaponModel); }
	static void ACTOR_ADD_WEAPON_AMMO(Actor_t _Actor, e_WeaponModel _WeaponModel, float _AmmoCount) { Invoke<0xCC69DCC1, void>(_Actor, _WeaponModel, _AmmoCount); }
	static float ACTOR_GET_WEAPON_AMMO(Actor_t _Actor, e_WeaponModel _WeaponModel) { return Invoke<0x43DEDFAE, float>(_Actor, _WeaponModel); }
	static void ACTOR_DISCARD_WEAPON_AMMO(Actor_t _Actor, e_WeaponModel _WeaponModel) { Invoke<0xEEC81873, void>(_Actor, _WeaponModel); }
	static bool ACTOR_HAS_VARIABLE_MESH(Actor_t _Actor, int _Id) { return Invoke<0xA091179F, bool>(_Actor, _Id); }
	static e_AmmoType GET_AMMOENUM_FOR_WEAPONENUM(e_WeaponModel _WeaponModel) { return Invoke<0x17883570, e_AmmoType>(_WeaponModel); }
	static e_WeaponModel GET_WEAPONENUM_FOR_AMMOENUM(Actor_t _Actor, e_AmmoType _AmmoType) { return Invoke<0xA8F64D32, e_WeaponModel>(_Actor, _AmmoType); }
	static void SET_WEAPON_GOLD(Actor_t _Actor, e_WeaponModel _WeaponModel, bool _Gold) { Invoke<0xAE44869D, void>(_Actor, _WeaponModel, _Gold); }
	static bool GET_WEAPON_GOLD(Actor_t _Actor, e_WeaponModel _WeaponModel) { return Invoke<0x6DBD1DDB, bool>(_Actor, _WeaponModel); }
	static bool IS_GOLDEN_GUNS_ON() { return Invoke<0x80B30545, bool>(); }
	static void FIRE_PROJECTILE(Actor_t Actor, const char* WeapGroup, float _Unk2, Vector3* Origin, Vector3* Target) { Invoke<0x195A4286, void>(Actor, WeapGroup, _Unk2, Origin, Target); }
	static void ACTOR_ADD_INV_AMMO(Actor_t _Actor, e_AmmoType _AmmoType, float _AmmoCount, bool _Unk0, bool _Notify) { Invoke<0x98B3ABFA, void>(_Actor, _AmmoType, _AmmoCount, _Unk0, _Notify); }
	static void ACTOR_SET_INV_AMMO(Actor_t _Actor, e_AmmoType _AmmoType, float _AmmoCount, bool _Unk0) { Invoke<0x4372593E, void>(_Actor, _AmmoType, _AmmoCount, _Unk0); }
	static void ACTOR_SET_INV_AMMO_MAX_AMOUNT(int _Unk0, int _Unk1, int _Unk2) { Invoke<0x6ADAAD87, void>(_Unk0, _Unk1, _Unk2); }
	static void ACTOR_SET_INV_AMMO_INFINITE(Actor_t _Actor, e_WeaponModel _WeaponModel, bool _Infinite) { Invoke<0x4FE2B586, void>(_Actor, _WeaponModel, _Infinite); }
	static float ACTOR_GET_INV_AMMO(Actor_t _Actor, e_AmmoType _AmmoType, bool _Unk) { return Invoke<0xE224AC6F, float>(_Actor, _AmmoType, _Unk); }
	static float ACTOR_GET_INV_AMMO_MAX_AMOUNT(Actor_t _Actor, e_AmmoType _AmmoType) { return Invoke<0x7AB368CF, float>(_Actor, _AmmoType); }
	static bool ACTOR_GET_INV_AMMO_INFINITE(Actor_t _Actor, e_WeaponModel _WeaponModel) { return Invoke<0xC666B987, bool>(_Actor, _WeaponModel); }
	...
	static Pickup_t CREATE_WEAPON_PICKUP(int _Unk0, int _Unk1, int _Unk2, int _Unk3, int _Unk4, int _Unk5, int _Unk6) { return Invoke<0xBF0235B0, Pickup_t>(_Unk0, _Unk1, _Unk2, _Unk3, _Unk4, _Unk5, _Unk6); }
	...
	static void DELETE_ALL_WEAPONS_FROM_ACTOR(Actor_t _Actor) { Invoke<0xD695F857, void>(_Actor); }
	static void DELETE_ALL_ACCESSORIES_FROM_ACTOR(Actor_t _Actor) { Invoke<0x96AC812B, void>(_Actor); }
	static void DELETE_ALL_INVENTORY_FROM_ACTOR(Actor_t _Actor) { Invoke<0x5AEB2E4F, void>(_Actor); }
...
namespace NET
{
	...
	static bool NET_START_NEW_SCRIPT(const char* _ScriptPath, int _StackSize) { return Invoke<0x84D6F8A7, bool>(_ScriptPath, _StackSize); }
	...
	static int _NET_IS_SLOT_VALID_IN_CLIENT_BROADCAST_VARIABLES(int _Unk0, int _Unk1) { return Invoke<0xF81E2097, int>(_Unk0, _Unk1); }
	static int _NET_IS_CLIENT_DATA_VALID_FOR_ALL_SLOTS(int _Unk0, int _Unk1) { return Invoke<0x64C2DD40, int>(_Unk0, _Unk1); }
	...
	static void NET_SET_UNLOCK() { Invoke<0x489A2B93, void>(); }
}
...
namespace NET_UI
{
	...
	static void NET_SET_FREE_ROAM_MODE(int _Mode) { Invoke<0x41921C98, void>(_Mode); }
	...
	static bool NET_AUTHENTICATE_GAMER(int _Unused, const char* _LaunchMode) { return Invoke<0x8E0D7219, bool>(_Unused, _LaunchMode); }
	...
	static void NET_PLAYER_LIST_SET_TITLE(const char* _GXTName) { Invoke<0x0547A660, void>(_GXTName); }
	static void NET_PLAYER_LIST_SET_TEMPLATE(int _Unk0) { Invoke<0xD6111569, void>(_Unk0); }
	static void NET_PLAYER_LIST_SET_HEADER(int _ColumnIndex, const char* _Entry) { Invoke<0xFA382FCB, void>(_ColumnIndex, _Entry); }
	...
	static int NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_STRING(int _ColumnIndex, const char* _String) { return Invoke<0xC673362C, int>(_ColumnIndex, _String); }
	static int NET_PLAYER_LIST_SET_CURRENT_ITEM_MSCORE_INT(int _ColumnIndex, int _Value) { return Invoke<0xEC6F465F, int>(_ColumnIndex, _Value); }
...
namespace OBJECT
{
	...
	static bool IS_LAYOUTREF_VALID(Layout_t _Layout) { return Invoke<0xFC8E55ED, bool>(_Layout); }
	static bool IS_OBJECT_VALID(Object_t _Object) { return Invoke<0xD7E7187B, bool>(_Object); }
	static bool IS_ITERATOR_VALID(Iterator_t _Iterator) { return Invoke<0x5A9CC0B0, bool>(_Iterator); }
	...
	static e_ObjectType GET_OBJECT_TYPE(Object_t _Object) { return Invoke<0x261ECB20, e_ObjectType>(_Object); }
	static int GET_NUM_OBJECTS_OF_TYPE(int _ObjectType) { return Invoke<0xADB08F12, int>(_ObjectType); }
	static int GET_MAX_NUM_OBJECTS_OF_TYPE(int _ObjectType) { return Invoke<0xA2866F3B, int>(_ObjectType); }
	static Layout_t FIND_NAMED_LAYOUT(const char* _LayoutName) { return Invoke<0x5699DE7E, Layout_t>(_LayoutName); }
	static const char* GET_ACTOR_NAME(Actor_t _Actor) { return Invoke<0x78CF43C1, const char*>(_Actor); } // Exact same as 'GET_OBJECT_NAME', no need to use this native.
	static const char* GET_OBJECT_NAME(Object_t _Object) { return Invoke<0xDF40614F, const char*>(_Object); }
	static const char* GET_LAYOUT_NAME(Layout_t _Layout) { return Invoke<0xBADE22A2, const char*>(_Layout); } // Exact same as 'GET_OBJECT_NAME', no need to use this native.
	static const char* GET_OBJECT_MODEL_NAME(Object_t _Object) { return Invoke<0x5C4262F9, const char*>(_Object); }
	...
	static Object_t GET_OBJECT_FROM_ACTOR(Actor_t _Actor) { return Invoke<0x4A2063EC, Object_t>(_Actor); }
	...
	static Layout_t GET_LAYOUT_FROM_OBJECT(Object_t _Object) { return Invoke<0x51D6DA2C, Layout_t>(_Object); }
	...
	static Layout_t CREATE_LAYOUT(const char* _LayoutName) { return Invoke<0x6CA53214, Layout_t>(_LayoutName); }
	...
	static PropSet_t CREATE_PROPSET_IN_LAYOUT(Layout_t _Layout, const char* _LayoutName, const char* _RefGroupPath, Vector2 _PositionXY, float _PositionZ, Vector2 _RotationXY, float _RotationZ) { return Invoke<0x779267C3, PropSet_t>(_Layout, _LayoutName, _RefGroupPath, _PositionXY, _PositionZ, _RotationXY, _RotationZ); }
	static Object_t CREATE_PROP_IN_LAYOUT(Layout_t _Layout, const char* _LayoutName, const char* _FragmentPath, Vector2 _PositionXY, float _PositionZ, Vector2 _RotationXY, float _RotationZ, bool _Frozen) { return Invoke<0xE351587D, Object_t>(_Layout, _LayoutName, _FragmentPath, _PositionXY, _PositionZ, _RotationXY, _RotationZ, _Frozen); }
	...
	static void RELEASE_LAYOUT_OBJECTS(Layout_t _Layout) { Invoke<0xE78E66F0, void>(_Layout); }
	static void DESTROY_LAYOUT_OBJECTS(Layout_t _Layout) { Invoke<0x28A2A4CC, void>(_Layout); }
	...
	static void RELEASE_ACTOR(Actor_t _Actor) { Invoke<0x32489AFB, void>(_Actor); }
	...
	static void DESTROY_VOLUME(Volume_t _Volume) { Invoke<0x8CAB944F, void>(_Volume); }
	static void DESTROY_ACTOR(Actor_t _Actor) { Invoke<0x8BD21869, void>(_Actor); }
	static void DESTROY_LAYOUT(Layout_t _Layout) { Invoke<0xC1756F39, void>(_Layout); }
	static void DESTROY_OBJECT(Object_t _Object) { Invoke<0x21144994, void>(_Object); }
	static void DESTROY_ITERATOR(Iterator_t _Iterator) { Invoke<0xE284A10C, void>(_Iterator); }
	...
	static Layout_t GET_AMBIENT_LAYOUT() { return Invoke<0xB52A3D48, Layout_t>(); }
	static int GET_ART_GRINGO_LAYOUT() { return Invoke<0x76FBF412, int>(); }
	static Layout_t GET_GC_LAYOUT() { return Invoke<0xADE13224, Layout_t>(); }
	static ObjectSet_t CREATE_OBJECTSET_IN_LAYOUT(const char* _Name, Layout_t _Layout, e_ObjectType _Type, bool _Unk3) { return Invoke<0x921B5F2B, ObjectSet_t>(_Name, _Layout, _Type, _Unk3); }
	static bool IS_OBJECTSET_VALID(ObjectSet_t _ObjectSet) { return Invoke<0x552189FD, bool>(_ObjectSet); }
	static int ADD_OBJECT_TO_OBJECTSET(int _Unk0, int _Unk1) { return Invoke<0x43FBBDE1, int>(_Unk0, _Unk1); }
	static int GET_OBJECTSET_SIZE(ObjectSet_t _ObjectSet) { return Invoke<0xE09DE8A0, int>(_ObjectSet); }
	...
	static Object_t GET_INDEXED_OBJECT_IN_OBJECTSET(int _Index, ObjectSet_t _ObjectSet) { return Invoke<0x50D39153, Object_t>(_Index, _ObjectSet); }
	static int IS_OBJECT_IN_OBJECTSET(int _Unk0, int _Unk1) { return Invoke<0x0114FCBD, int>(_Unk0, _Unk1); }
	static void REMOVE_OBJECT_FROM_OBJECTSET(Object_t _Object, ObjectSet_t _ObjectSet) { Invoke<0xA3E05BAE, void>(_Object, _ObjectSet); }
	static void CLEAN_OBJECTSET(ObjectSet_t _ObjectSet) { Invoke<0x11EE07B5, void>(_ObjectSet); }
	...
	static PopulationSet_t CREATE_NAMED_POPULATION_SET(const char* _PopSetName, int _Index) { return Invoke<0xB0882841, PopulationSet_t>(_PopSetName, _Index); }
	...
	static Iterator_t CREATE_OBJECT_ITERATOR(Layout_t _Layout) { return Invoke<0xD8A12B74, Iterator_t>(_Layout); }
	static int CREATE_NAMED_OBJECT_ITERATOR(int _Unk0, int _Unk1) { return Invoke<0x2F358B89, int>(_Unk0, _Unk1); }
	static Object_t START_OBJECT_ITERATOR(Iterator_t _Iterator) { return Invoke<0xE96A0318, Object_t>(_Iterator); }
	static int OBJECT_ITERATOR_NEXT(Iterator_t _Iterator) { return Invoke<0xD88DC865, int>(_Iterator); }
	static int OBJECT_ITERATOR_PREV(Iterator_t _Iterator) { return Invoke<0x91A3A831, int>(_Iterator); }
	...
	static void ITERATE_ON_OBJECT_TYPE(Iterator_t _Iterator, int Type) { Invoke<0xBE553F84, void>(_Iterator, Type); }
	...
	static void ITERATE_IN_LAYOUT(Iterator_t _Iterator, Layout_t _Layout) { Invoke<0xF3ABE99C, void>(_Iterator, _Layout); }
	static void ITERATE_IN_SET(Iterator_t _Iterator, IterationSet_t _IterationSet) { Invoke<0xDF6B5E94, void>(_Iterator, _IterationSet); }
	...
	static Object_t FIND_OBJECT_IN_LAYOUT(Layout_t _Layout, const char* ObjectName) { return Invoke<0xCF875EFA, Object_t>(_Layout, ObjectName); }
	static Actor_t FIND_ACTOR_IN_LAYOUT(Layout_t _Layout, const char* ActorName) { return Invoke<0x53A761DE, Actor_t>(_Layout, ActorName); }
	static Volume_t FIND_VOLUME_IN_LAYOUT(Layout_t _Layout, const char* _VolumeName) { return Invoke<0xAC830865, Volume_t>(_Layout, _VolumeName); }
	...
	static Vector3 GET_OBJECT_POSITION(Object_t _Object) { Vector3 position; Invoke<0x31201B4C, bool>(_Object, &position); return position; }
	static int ROTATE_OBJECT_AROUND_AXIS(int _Unk0, int _Unk1, int _Unk2) { return Invoke<0x3C45D66A, int>(_Unk0, _Unk1, _Unk2); }
	static bool GET_OBJECT_AXIS(Object_t _Object, Vector3* _Axis, int _RotationOrder) { return Invoke<0xCE412E46, bool>(_Object, _Axis, _RotationOrder); }
	static bool GET_OBJECT_RELATIVE_POSITION(Object_t _Object, Vector3* _Input, int _Unused, Vector3* _Output) { return Invoke<0x2243EA59, bool>(_Object, _Input, _Unused, _Output); }
	static bool GET_OBJECT_RELATIVE_OFFSET(Object_t _Object, Vector3* _Input, int _Unused, Vector3* _Output) { return Invoke<0x15CDF203, bool>(_Object, _Input, _Unused, _Output); }
	...
	static Vector3 GET_OBJECT_ORIENTATION(Object_t _Object) { Vector3 rotation; Invoke<0x27B7D6D6, bool>(_Object, &rotation); return rotation; }
	static float GET_OBJECT_HEADING(Object_t _Object) { return Invoke<0x1C02D2F8, float>(_Object); }
	static bool SET_OBJECT_POSITION(Object_t _Object, Vector2 _PositionXY, float _PositionZ) { return Invoke<0xC5D796F8, bool>(_Object, _PositionXY, _PositionZ); }
	static void SET_OBJECT_POSITION_ON_GROUND(Object_t _Object, Vector2 _PositionXY, float _PositionZ) { Invoke<0x5AB0BBA6, void>(_Object, _PositionXY, _PositionZ); }
	static bool SET_OBJECT_ORIENTATION(Object_t _Object, Vector2 _OrientationXY, float _OrientationZ) { return Invoke<0xC8A4EE74, bool>(_Object, _OrientationXY, _OrientationZ); }
	static int SNAP_OBJECT_TO_GROUND(Object_t _Object, float _Unk1, float _Unk2, float _Unk3) { return Invoke<0xF437B3D9, int>(_Object, _Unk1, _Unk2, _Unk3); }
	static bool GET_OBJECT_NAMED_BONE_POSITION(Object_t _Object, const char* _BoneName, Vector3* _Position) { return Invoke<0x30516389, bool>(_Object, _BoneName, _Position); }
	...
	static int GET_OBJECT_ATTACHEMENT(int _Unk0) { return Invoke<0x78B73E47, int>(_Unk0); }
	static int GET_OBJECT_ATTACHED_TO(int _Unk0) { return Invoke<0x533475AE, int>(_Unk0); }
	static int ATTACH_OBJECTS(Object_t _Object1, Object_t _Object2, const char* _Locator, Vector2 _PositionXY, float _PositionZ, Vector2 _RotationXY, float _RotationZ, int _Unk7) { return Invoke<0xE1421B42, int>(_Object1, _Object2, _Locator, _PositionXY, _PositionZ, _RotationXY, _RotationZ, _Unk7); }
	...
	static void DEREFERENCE_ACTOR(Actor_t _Actor) { Invoke<0x92339B5E, void>(_Actor); }
	...
	static Actor_t CREATE_ACTOR_IN_LAYOUT(Layout_t _Layout, const char* _ActorName, e_ActorModel _Model, Vector2 _PositionXY, float _PositionZ, Vector2 _RotationXY, float _RotationZ) { return Invoke<0x8D67F397, Actor_t>(_Layout, _ActorName, _Model, _PositionXY, _PositionZ, _RotationXY, _RotationZ); }
	static Actor_t CREATE_PLAYER_ACTOR_IN_LAYOUT(Layout_t _Layout, const char* _ActorName, e_ActorModel _Model, Vector2 _PositionXY, float _PositionZ, Vector2 _RotationXY, float _RotationZ, int _OutfitVariation) { return Invoke<0x6A307D5F, Actor_t>(_Layout, _ActorName, _Model, _PositionXY, _PositionZ, _RotationXY, _RotationZ, _OutfitVariation); }
	...
	static Actor_t RESPAWN_PLAYER_ACTOR_IN_LAYOUT(Layout_t _Layout, Actor_t _Actor, const char* _ActorInLayout, e_ActorModel _Model, Vector2 _PositionXY, float _PositionZ, Vector2 _RotationXY, float _RotationZ, int _OutfitVariation) { return Invoke<0x637E446B, Actor_t>(_Layout, _Actor, _ActorInLayout, _Model, _PositionXY, _PositionZ, _RotationXY, _RotationZ, _OutfitVariation); }
	static int IS_ACTOR_INITED(int _Unk0) { return Invoke<0x24F4DAB2, int>(_Unk0); }
	static e_ActorModel GET_ACTOR_ENUM(Actor_t _Actor) { return Invoke<0x0B28E9EC, e_ActorModel>(_Actor); }
	static const char* GET_ACTOR_ENUM_STRING(Actor_t _Actor) { return Invoke<0xD98CB6F6, const char*>(_Actor); }
	...
	static int GET_ACTOR_ENUM_VARIATION_COUNT(e_ActorModel _Model) { return Invoke<0xB50E95D7, int>(_Model); }
	static int GET_ACTOR_ENUM_FACTION(int _Unk0) { return Invoke<0x2803BDA8, int>(_Unk0); }
	static void SWITCH_ACTOR_ENUM_VARIATION(Actor_t _Actor, int _VariationId) { Invoke<0x7AB17813, void>(_Actor, _VariationId); }
	static void SWITCH_PLAYER_TO_ENUM(e_ActorModel _Model, int _VariationId) { Invoke<0x95FBA0B0, void>(_Model, _VariationId); }
	static void TURN_ACTOR_INTO_ZOMBIE(Actor_t _Actor, e_ActorModel _Model) { Invoke<0x39928706, void>(_Actor, _Model); }
	static void SET_ACTOR_HARD_LOCK_AQUIRE_BONE_CASUAL(Actor_t _Actor, const char* _BoneName) { Invoke<0x12A86E9D, void>(_Actor, _BoneName); }
	static void SET_ACTOR_HARD_LOCK_AQUIRE_BONE(Actor_t _Actor, const char* _BoneName) { Invoke<0x5613615B, void>(_Actor, _BoneName); }
	static int REQUEST_ASSET(const char* AssetDir, e_AssetType _AssetType) { return Invoke<0x9AA02DA7, int>(AssetDir, _AssetType); }
	static int GET_ASSET_ID(const char* _AssetPath, e_AssetType _AssetType) { return Invoke<0x6005B514, int>(_AssetPath, _AssetType); }
	...
	static const char* GET_ASSET_NAME(int _AssetId, e_AssetType _AssetType) { return Invoke<0x9EDBBB84, const char*>(_AssetId, _AssetType); }
	...
	static void SET_PROP_COLLIDE_WITH_WORLD(Object_t _Object, bool _Collide) { Invoke<0xCEC355CE, void>(_Object, _Collide); }
	static void SET_PROP_COLLIDE_WITH_MOVABLES(Object_t _Object, bool _Collide) { Invoke<0x418A22D5, void>(_Object, _Collide); }
	static void SET_PROP_COLLIDE_WITH_OBJECT(Object_t _Object1, Object_t _Object2, bool _Collide) { Invoke<0x77403213, void>(_Object1, _Object2, _Collide); }
	static void SET_OBJECT_COLLIDE_WITH_WORLD(Object_t _Object, bool _Collide) { Invoke<0x601FC9F4, void>(_Object, _Collide); }
	static void SET_OBJECT_COLLIDE_WITH_MOVABLES(Object_t _Object, bool _Collide) { Invoke<0x05D69EA6, void>(_Object, _Collide); }
	static void SET_OBJECT_COLLIDE_WITH_OBJECT(Object_t _Object1, Object_t _Object2, bool _Collide) { Invoke<0x9AC1CA75, void>(_Object1, _Object2, _Collide); }
	static int SET_PROP_AI_OBSTACLE_ENABLED(int _Unk0, int _Unk1) { return Invoke<0x0DC83543, int>(_Unk0, _Unk1); }
	static int GET_CURVE_FROM_OBJECT(Object_t _Object) { return Invoke<0x49D0DF2E, int>(_Object); }
	static void DESTROY_CURVEQUERY(int _Unk0) { Invoke<0xDF93BD7C, void>(_Unk0); }
	static void DESTROY_CAMERA(Camera_t _Camera) { Invoke<0x767E08D0, void>(_Camera); }
...
namespace PERSCHAR
{
	...
	static void REVIVE_PERS_CHAR(int _Unk0, bool _FullRevive) { Invoke<0xEDA4B02B, void>(_Unk0, _FullRevive); }
...
namespace PHYSICS
{
	static bool GET_PHYSINST_VELOCITY(int _Physinst, Vector3* _Velocity) { return Invoke<0x17B69196, bool>(_Physinst, _Velocity); }
	...
	static void SET_PHYSINST_FROZEN(int _PhysInst, bool _Frozen) { Invoke<0x2C0AF634, void>(_PhysInst, _Frozen); }
	static bool IS_PHYSINST_FROZEN(int _PhysInst) { return Invoke<0x789AA2B2, bool>(_PhysInst); }
...
namespace PHYSINST
{
	...
	static bool SET_PROP_VELOCITY(int _Physinst, Vector3* _Velocity) { return Invoke<0x28425D8C, bool>(_Physinst, _Velocity); }
	...
	static void HIDE_PHYSINST(int _Physinst) { Invoke<0x0D6BFDD9, void>(_Physinst); }
	static void SHOW_PHYSINST(int _Physinst) { Invoke<0x342FDCD6, void>(_Physinst); }
...
namespace PPPELEMENTS
{
	...
	static void ZOMBIEMODE_ENABLED(bool _Enable) { Invoke<0xDF505043, void>(_Enable); }
...
namespace PROP
{
	static int GET_PHYSINST_FROM_OBJECT(Object_t _Object) { return Invoke<0xDB70DF0C, int>(_Object); }
	...
	static bool PROP_IS_VARIABLE_MESH_ENABLED(Object_t _Object, int _VariableMesh) { return Invoke<0x375A33F0, bool>(_Object, _VariableMesh); }
	static int PROP_ENABLE_VARIABLE_MESH(Object_t _Object, int _VariableMesh, bool _Enable) { return Invoke<0x8287F8B3, int>(_Object, _VariableMesh, _Enable); }
...
namespace RENDER
{
	static void RENDERING_ENABLE_CHARACTER_CLIPPING(bool _EnableClipping) { Invoke<0x6AF07F86, void>(_EnableClipping); }
	static void PRINT_FRAME_TIME(int _FrameIndex) { Invoke<0xB84DE79E, void>(_FrameIndex); }
...
namespace RIDING
{
	...
	static bool IS_ACTOR_RIDING(Actor_t _Actor) { return Invoke<0xA6BBE769, bool>(_Actor); }
	...
	static Actor_t GET_MOUNT(Actor_t _Actor) { return Invoke<0xDD31EC4E, Actor_t>(_Actor); }
	...
	static void HORSE_SET_CURR_FRESHNESS(Actor_t _Actor, float _Value) { Invoke<0xF3976D70, void>(_Actor, _Value); }
	static float HORSE_GET_CURR_FRESHNESS(Actor_t _Actor) { return Invoke<0xB8665D8A, float>(_Actor); }
...
namespace STREAM
{
	static void STREAMING_REQUEST_ACTOR(e_ActorModel _Model, bool _Unk0, bool _Unk1) { Invoke<0xB0A79FEE, void>(_Model, _Unk0, _Unk1); }
	static bool STREAMING_IS_ACTOR_LOADED(e_ActorModel _Model, int _Unk) { return Invoke<0x7DF72579, bool>(_Model, _Unk); }
	...
	static bool STREAMING_IS_PROPSET_LOADED(int _AssetId) { return Invoke<0xF7D65903, bool>(_AssetId); }
	static void STREAMING_EVICT_PROPSET(int _AssetId) { Invoke<0x4A5E4C13, void>(_AssetId); }
	...
	static void STREAMING_REQUEST_SCRIPT(int _AssetId) { Invoke<0x11E57A92, void>(_AssetId); }
	static bool STREAMING_IS_SCRIPT_LOADED(int _AssetId) { return Invoke<0xB5B4AEAD, bool>(_AssetId); }
	...
	static void STREAMING_LOAD_SCENE_EXT(Vector2 _PositionXY1, float _PositionZ1, Vector2 _PositionXY2, float _PositionZ2, bool _Unk5) { Invoke<0xCB1E8485, void>(_PositionXY1, _PositionZ1, _PositionXY2, _PositionZ2, _Unk5); }
	...
	static void STREAMING_ENABLE_POI_STREAMING(bool _Enable) { Invoke<0x49E4EB10, void>(_Enable); }
	static void STREAMING_PREVENT_SNIPER_MODE(int _Unk0) { Invoke<0x5F4C08A2, void>(_Unk0); }
	static void STREAMING_SET_CUTSCENE_MODE(bool _Enable) { Invoke<0x83088F62, void>(_Enable); }
	static void STREAMING_ENABLE_BOUNDS(bool _Enable) { Invoke<0x0BEBB187, void>(_Enable); }
	static void STREAMING_LOAD_BOUNDS(Vector2 _PositionXY, float _PositionZ, float _Radius, bool _Unk4) { Invoke<0x0F8FC4D0, void>(_PositionXY, _PositionZ, _Radius, _Unk4); }
	static void STREAMING_LOAD_BOUNDS_EXT(int _Index, Vector2 _PositionXY, float _PositionZ, float _Radius, bool _Unk4) { Invoke<0x1CD960B8, void>(_Index, _PositionXY, _PositionZ, _Radius, _Unk4); }
	...
	static void STREAMING_ENABLE_FORCE_FRAGMENT_HIGH_LOD(Object_t _Object) { Invoke<0xBEABC729, void>(_Object); }
	static void STREAMING_DISABLE_FORCE_FRAGMENT_HIGH_LOD(Object_t _Object) { Invoke<0xB226E8E3, void>(_Object); }
	static void STREAMING_ENABLE_FORCE_CHILD_SECTOR_HIGH_LOD(const char* _SectorName) { Invoke<0xE981992C, void>(_SectorName); }
	static void STREAMING_DISABLE_FORCE_CHILD_SECTOR_HIGH_LOD(const char* _SectorName) { Invoke<0x8CC6066C, void>(_SectorName); }
...
namespace STRING
{
	...
	static Hash_t STRING_TO_HASH(const char* _Str) { return Invoke<0x84415E28, Hash_t>(_Str); }
...
namespace TARGETING
{
	static Actor_t GET_ACTOR_UNDER_RETICLE(Actor_t _Actor, int _Flag) { return Invoke<0x86BAAC6C, Actor_t>(_Actor, _Flag); }
	static bool GET_RETICLE_TARGET_POINT(Actor_t _Actor, Vector3* _Position) { return Invoke<0x8AE7281E, bool>(_Actor, _Position); }
	static void SET_PLAYER_PERFECT_ACCURACY(Player_t _Player, bool _Enabled) { Invoke<0x5F566576, void>(_Player, _Enabled); }
	...
	static bool IS_ACTOR_IN_ACCURACY_RANGE(Actor_t _Actor) { return Invoke<0x7E124E62, bool>(_Actor); }
...
namespace TASKS
{
	...
	static void TASK_CROUCH(Actor_t _Actor, float _Durability) { Invoke<0x616C803C, void>(_Actor, _Durability); }
	...
	static void TASK_FLEE_ACTORSET(int _Unk0, const char* _Unk1, float _Unk2, float _Unk3, int _Unk4, int _Unk5, int _Unk6) { Invoke<0xCD5E23C3, void>(_Unk0, _Unk1, _Unk2, _Unk3, _Unk4, _Unk5, _Unk6); }
	static void TASK_FOLLOW_ACTOR(Actor_t _Actor, Actor_t _Target) { Invoke<0x12F0911A, void>(_Actor, _Target); }
	...
	static void TASK_GO_TO_COORD(Actor_t _Actor, const Vector3* _Position, int _MoveType) { Invoke<0x8C574832, void>(_Actor, _Position, _MoveType); }
	...
	static void TASK_VEHICLE_ENTER(Actor_t _Actor, Vehicle_t _Vehicle, int _Unk2, int _Unk3) { Invoke<0xB2CD5160, void>(_Actor, _Vehicle, _Unk2, _Unk3); }
	...
	static void TASK_OVERRIDE_SET_MOVESPEED_ABSOLUTE(Actor_t _Actor, float _Speed) { Invoke<0xCE843315, void>(_Actor, _Speed); }
	static void TASK_OVERRIDE_SET_MOVESPEED_NORMALIZED(Actor_t _Actor, float _Speed) { Invoke<0x96F3BD31, void>(_Actor, _Speed); }
...
namespace TIME
{
	...
	static int GET_HOUR(Time_t _PackedTime) { return Invoke<0x2765C37E, int>(_PackedTime); }
	static int GET_MINUTE(Time_t _PackedTime) { return Invoke<0x1020BF6D, int>(_PackedTime); }
	static int GET_SECOND(Time_t _PackedTime) { return Invoke<0xBA8077CF, int>(_PackedTime); }
	static int GET_DAY(Time_t _PackedTime) { return Invoke<0x63D13FB0, int>(_PackedTime); }
	...
	static Time_t GET_TIME_OF_DAY() { return Invoke<0x4E1DE7A5, Time_t>(); }
	static Time_t MAKE_TIME_OF_DAY(int _Hour, int _Minute, int _Second) { return Invoke<0xC09EAB6E, Time_t>(_Hour, _Minute, _Second); }
	static Time_t MAKE_TIME_OF_DAY_EX(int _Day, int _Hour, int _Minute, int _Second) { return Invoke<0x0E453CF0, Time_t>(_Day, _Hour, _Minute, _Second); }
	...
	static void SET_TIME_OF_DAY(Time_t _PackedTime) { Invoke<0xAD03186C, void>(_PackedTime); }
...
namespace UI
{
	static void UI_STACKPUSH(const char* _ScaleformLayer) { Invoke<0xB1A2028A, void>(_ScaleformLayer); }
	...
	static void UI_GOTO(const char* _UILayer) { Invoke<0xA0159C77, void>(_UILayer); }
	...
	static void UI_REGISTER_STREAMING_TEXTURE(const char* _Dir, const char* _Tex, int _Unk2, int _Unk3) { Invoke<0x1F9EE9E1, void>(_Dir, _Tex, _Unk2, _Unk3); }
	static void UI_SET_STRING(const char* _GXTName, const char* _String) { Invoke<0xE457546C, void>(_GXTName, _String); }
	static void UI_SET_STRING_FORMAT(const char* _GXTName, const char* _Format, const char* _String1, const char* _String2, const char* _String3) { Invoke<0xEDA84121, void>(_GXTName, _Format, _String1, _String2, _String3); }
	...
	static const char* UI_GET_STRING_BY_HASH(Hash_t _Hash) { return Invoke<0xBA89F5EA, const char*>(_Hash); }
	...
	static void UI_SET_TEXT(const char* entry, const char* text) { Invoke<0xC464D5DD, void>(entry, text); }
	...
	static int UI_IS_FUIMOVIE_LOADED(int _Unk0) { return Invoke<0x9D20BDC4, int>(_Unk0); }
}
...
namespace VEHICLES
{
	static Vehicle_t GET_ACTOR_MOST_RECENT_VEHICLE(Actor_t _Actor) { return Invoke<0x58745E4B, Vehicle_t>(_Actor); }
	static bool IS_ACTOR_ON_TRAIN(Actor_t _Actor, bool _Unk0) { return Invoke<0xD36E2D54, bool>(_Actor, _Unk0); }
	static bool IS_ACTOR_ON_BOAT(Actor_t _Actor) { return Invoke<0x9EE8AB59, bool>(_Actor); }
	static bool IS_ACTOR_VEHICLE(Actor_t _Actor) { return Invoke<0x9751B167, bool>(_Actor); }
	static bool IS_ACTOR_DRAFT_VEHICLE(Actor_t _Actor) { return Invoke<0x5D41D423, bool>(_Actor); }
	static bool IS_ACTOR_DRIVING_VEHICLE(Actor_t _Actor) { return Invoke<0xDC99C124, bool>(_Actor); }
	static bool IS_ACTOR_JACKING_VEHICLE(Actor_t _Actor) { return Invoke<0x1BA90C92, bool>(_Actor); }
	static bool IS_ACTOR_INSIDE_VEHICLE(Actor_t _Actor) { return Invoke<0x12325AE7, bool>(_Actor); }
	static bool IS_ACTOR_RIDING_VEHICLE(Actor_t _Actor) { return Invoke<0xDE19A1F9, bool>(_Actor); }
	static Vehicle_t GET_VEHICLE(Actor_t _Actor) { return Invoke<0xA0936EB6, Vehicle_t>(_Actor); }
	static int GET_ACTOR_VEHICLE_STATE(int _Unk0, int _Unk1, int _Unk2) { return Invoke<0xCEA2449F, int>(_Unk0, _Unk1, _Unk2); }
	static int GET_NUM_DRAFTED_ACTORS(Actor_t _Actor) { return Invoke<0xDAB0D820, int>(_Actor); }
	static bool SET_ACTOR_IN_VEHICLE(Actor_t _Actor, Vehicle_t _Vehicle, int _SeatId) { return Invoke<0x32974F99, bool>(_Actor, _Vehicle, _SeatId); }
	static Actor_t GET_DRAFT_ACTOR(int _HarnessId, Actor_t _Actor) { return Invoke<0x48D5121D, int>(_HarnessId, _Actor); }
	static bool IS_ACTOR_DRAFTED(Actor_t _Actor) { return Invoke<0xEF2C329D, bool>(_Actor); }
	...
	static Actor_t GET_ACTOR_IN_VEHICLE_SEAT(Vehicle_t _Vehicle, int _SeatId) { return Invoke<0xE8E94C3B, Actor_t>(_Vehicle, _SeatId); }
	static int GET_NUM_AVAILABLE_SEATS(Vehicle_t _Vehicle) { return Invoke<0x3ACE659E, int>(_Vehicle); }
	static int GET_NUM_OCCUPIED_SEATS(Vehicle_t _Vehicle) { return Invoke<0xF0354E46, int>(_Vehicle); }
	static bool ENABLE_VEHICLE_SEAT(Vehicle_t _Vehicle, int _SeatId, bool _Enable) { return Invoke<0x6AC8234D, bool>(_Vehicle, _SeatId, _Enable); }
	static void STOP_VEHICLE(Vehicle_t _Vehicle) { Invoke<0xC2232D29, void>(_Vehicle); }
	static void START_VEHICLE(Vehicle_t _Vehicle) { Invoke<0xE4442AB2, void>(_Vehicle); }
	static void ACCESSORIZE_VEHICLE_HORSES(Vehicle_t _Vehicle, int _Unk1) { Invoke<0xB12584C8, void>(_Vehicle, _Unk1); }
	static int GET_NUM_DRAFT_POSITIONS(int _Unk0) { return Invoke<0xD85CA776, int>(_Unk0); }
	static void ATTACH_DRAFT_TO_VEHICLE(Actor_t _Actor, Vehicle_t _Vehicle, int _Position, bool _Unk) { Invoke<0xB0A81226, void>(_Actor, _Vehicle, _Position, _Unk); }
	...
	static int DETACH_DRAFT_FROM_VEHICLE_BY_INDEX(int _Unk0) { return Invoke<0x8C3B533B, int>(_Unk0); }
	...
	static void SET_VEHICLE_ENGINE_RUNNING(Vehicle_t _Vehicle, bool _IsRunning) { Invoke<0x462B5FDF, void>(_Vehicle, _IsRunning); }
	static bool IS_VEHICLE_ENGINE_RUNNING(Vehicle_t _Vehicle) { return Invoke<0x8257A916, bool>(_Vehicle); }
	static void SET_VEHICLE_ALLOWED_TO_DRIVE(Vehicle_t _Vehicle, bool _Allowed) { Invoke<0x55A56DF8, void>(_Vehicle, _Allowed); }
	static bool IS_VEHICLE_ALLOWED_TO_DRIVE(Vehicle_t _Vehicle) { return Invoke<0x1C391A44, bool>(_Vehicle); }
	static void SET_VEHICLE_PASSENGERS_ALLOWED(Vehicle_t _Vehicle, bool _Allowed) { Invoke<0xBD0C1BEA, void>(_Vehicle, _Allowed); }
	static void SET_VEHICLE_EJECTION_ENABLED(Vehicle_t _Vehicle, bool _Enabled) { Invoke<0x0ABD83C0, void>(_Vehicle, _Enabled); }
	static void VEHICLE_SET_HANDBRAKE(Vehicle_t _Vehicle, bool _Handbreak) { Invoke<0x384BB6AB, void>(_Vehicle, _Handbreak); }
	static bool IS_ANY_VEHICLE_WHEEL_DETACHED(Vehicle_t _Vehicle, int _Unk1, int _Unk2) { return Invoke<0xF801CBD7, bool>(_Vehicle, _Unk1, _Unk2); }
...
namespace VOLUME
{
	static bool IS_VOLUME_VALID(Volume_t _Volume) { return Invoke<0xBC33CEB5, bool>(_Volume); }
	static bool IS_POINT_IN_VOLUME(float _X, float _Y, float _Z, Volume_t _Volume) { return Invoke<0xB85BB21B, bool>(_X, _Y, _Z, _Volume); }
	static bool IS_ACTOR_IN_VOLUME(Actor_t _Actor, Volume_t _Volume) { return Invoke<0xF5593A78, bool>(_Actor, _Volume); }
	static void DELETE_PROJECTILES_IN_VOLUME(Volume_t _Volume) { Invoke<0x0F474297, void>(_Volume); }
	static void GET_VOLUME_CENTER(Volume_t _Volume, Vector3* _Center) { Invoke<0x6729EEFE, void>(_Volume, _Center); }
	static void SET_VOLUME_ENABLED(Volume_t _Volume, bool _Enable) { Invoke<0x14D5CFC3, void>(_Volume, _Enable); }
	static bool IS_VOLUME_ENABLED(Volume_t _Volume) { return Invoke<0x29ED6F03, bool>(_Volume); }
	static float GET_VOLUME_HEADING(Volume_t _Volume) { return Invoke<0x8D5609F2, float>(_Volume); }
	static void GET_VOLUME_SCALE(Volume_t _Volume, Vector3* _Scale) { Invoke<0xE9C34ACC, void>(_Volume, _Scale); }
	static void GENERATE_RANDOM_POINT_IN_VOLUME(Volume_t _Volume, int _Unk1) { Invoke<0x9FC69F27, void>(_Volume, _Unk1); }
	static void FIND_VOL_SURFACE_POINTS_FOR_POINT(Volume_t _Volume, int _Unk1, int _Unk2, int _Unk3) { Invoke<0x026F7060, void>(_Volume, _Unk1, _Unk2, _Unk3); }
}
...
namespace WEAPON
{
	...
	static const char* GET_WEAPON_ENUM_STRING_FROM_ENUM(e_WeaponModel _WeaponModel) { return Invoke<0x6A9CFA2A, const char*>(_WeaponModel); }
	static const char* GET_WEAPON_DISPLAY_NAME(e_WeaponModel _WeaponModel) { return Invoke<0x35CD589C, const char*>(_WeaponModel); }
	static const char* GET_WEAPON_INTERNAL_NAME(e_WeaponModel _WeaponModel) { return Invoke<0x87C5471F, const char*>(_WeaponModel); }
	static const char* _GET_WEAPON_ICON_NAME(e_WeaponModel _WeaponModel) { return Invoke<0xBE06C265, const char*>(_WeaponModel); }
	static const char* GET_WEAPON_FRAGMENT_NAME(e_WeaponModel _WeaponModel) { return Invoke<0xE8739A48, const char*>(_WeaponModel); }
	...
	static void SET_WEAPONENUM_LOCKED(e_WeaponModel _WeaponModel, bool _IsLocked) { Invoke<0x0E4B7A33, void>(_WeaponModel, _IsLocked); }
	static bool IS_WEAPONENUM_LOCKED(e_WeaponModel _WeaponModel) { return Invoke<0xCCE4A339, bool>(_WeaponModel); }
	static e_WeaponCategory GET_WEAPON_CATEGORY_FROM_ENUM(e_WeaponModel _WeaponModel) { return Invoke<0xDB679ED9, e_WeaponCategory>(_WeaponModel); }
	static e_AmmoType GET_AMMO_ENUM(e_WeaponModel _WeaponModel) { return Invoke<0xD3E16075, e_AmmoType>(_WeaponModel); }
	static void SET_AMMO_DROP_BIAS(int _Unk0, int _Unk1) { Invoke<0x08A655C5, void>(_Unk0, _Unk1); }
	static const char* GET_AMMO_ENUM_STRING_FROM_ENUM(e_AmmoType _AmmoType) { return Invoke<0xCCB57C38, const char*>(_AmmoType); }
	static const char* GET_AMMO_ENUM_ICON_NAME(e_AmmoType _AmmoType) { return Invoke<0x2AF84928, const char*>(_AmmoType); }
	static float GET_WEAPON_MAX_AMMO(e_WeaponModel _WeaponModel) { return Invoke<0xA677B204, float>(_WeaponModel); }
	static void RESOLVE_DLC_WEAPONENUM(e_WeaponModel _WeaponModel) { Invoke<0xD291A820, void>(_WeaponModel); }
...
namespace WEATHER
{
	static void SET_WEATHER(e_Weather _Weather, float _TransitionSpeed) { Invoke<0x456D7F38, void>(_Weather, _TransitionSpeed); }
	static e_Weather GET_WEATHER() { return Invoke<0xEA026ED9, e_Weather>(); }
	static void SET_WEATHER_COMPLEX(Time_t _Time, int _Unk1, int _Unk2, int _Unk3, int _Unk4, int _Unk5, int _Unk6, int _Unk7, int _Unk8, int _Unk9, int _Unk10, int _Unk11, int _Unk12, int _Unk13, int _Unk14) { Invoke<0xC157CA40, void>(_Time, _Unk1, _Unk2, _Unk3, _Unk4, _Unk5, _Unk6, _Unk7, _Unk8, _Unk9, _Unk10, _Unk11, _Unk12, _Unk13, _Unk14); }
	...
	static void OVERRIDE_BENCHMARK_WEATHER(e_Weather _Weather) { Invoke<0x8291ED47, void>(_Weather); }
	static void OVERRIDE_BENCHMARK_TIME(Time_t _Time) { Invoke<0xB288F455, void>(_Time); }
}
...
namespace WORLD
{
	...
	static void SET_ZOMBIE_DLC_IS_ACTIVE(bool _Active) { Invoke<0x28246500, void>(_Active); }
	...
	static int CREATE_FIRE_ON_OBJECT(Object_t _Object) { return Invoke<0xC587FA2B, int>(_Object); }
	...
	static void REPLACE_WORLD_SECTOR_LOAD_BOUNDING_BOX(const char* _SectorName) { Invoke<0x08D06543, void>(_SectorName); }
	...
	static void SET_USE_ACTOR_STAGGER(Actor_t _Actor) { Invoke<0xE437932A, void>(_Actor); }
	static FireHandle_t FIRE_CREATE_HANDLE() { return Invoke<0xBBAE9CBD, FireHandle_t>(); }
	static bool FIRE_IS_HANDLE_VALID(FireHandle_t _FireHandle) { return Invoke<0xA488E930, bool>(_FireHandle); }
	static void FIRE_RELEASE_HANDLE(FireHandle_t _FireHandle, bool _Deactivate) { Invoke<0xB14B936A, void>(_FireHandle, _Deactivate); }
	static void FIRE_RELEASE_INFINITE_HANDLE(FireHandle_t _FireHandle, float _ReleaseStrength, float _Unk0) { Invoke<0xD2BB733E, void>(_FireHandle, _ReleaseStrength, _Unk0); }
	static FireHandle_t FIRE_FIND_HANDLE_FROM_ATTACHED_ACTOR(Actor_t _Actor) { return Invoke<0x91396EB7, FireHandle_t>(_Actor); }
	static void FIRE_CREATE_ON_ACTOR(FireHandle_t _FireHandle, Actor_t _Actor) { Invoke<0x9679CF84, void>(_FireHandle, _Actor); }
	static void FIRE_CREATE_IN_VOLUME(FireHandle_t _FireHandle, Vector2 _PositionXY, float _PositionZ, int _HeightFlag, int _Flag) { Invoke<0xB65ADFAC, void>(_FireHandle, _PositionXY, _PositionZ, _HeightFlag, _Flag); }
	static bool FIRE_IS_ACTOR_ON_FIRE(Actor_t _Actor) { return Invoke<0x30C4CA99, bool>(_Actor); }
	static void FIRE_STOP_ALL_FIRES() { Invoke<0x15001332, void>(); }
	static void FIRE_STOP_ON_ACTOR(Actor_t _Actor) { Invoke<0xF635B9EA, void>(_Actor); }
	static void FIRE_STOP_FLAMES_IN_VOLUME(int _Unk0) { Invoke<0x11A65FFB, void>(_Unk0); }
	static Actor_t FIRE_GET_OWNER(FireHandle_t _FireHandle) { return Invoke<0x15683736, Actor_t>(_FireHandle); }
	static void FIRE_SET_OWNER(FireHandle_t _FireHandle, Actor_t _Actor) { Invoke<0xE5C7E4C9, void>(_FireHandle, _Actor); }
	static void FIRE_SET_DAMAGE_ALLOWED(FireHandle_t _FireHandle, bool _DamageAllowed) { Invoke<0x3D5D3B26, void>(_FireHandle, _DamageAllowed); }
	static void FIRE_SET_CONTROL_VOLUME(int _Unk0, int _Unk1) { Invoke<0x03240324, void>(_Unk0, _Unk1); }
	static void FIRE_SET_MAX_FLAMES(FireHandle_t _FireHandle, int _MaxFlames) { Invoke<0xE5E04E83, void>(_FireHandle, _MaxFlames); }
	static void FIRE_SET_TARGET_FILL_PERCENT(FireHandle_t _FireHandle, float _TargetFillPercent) { Invoke<0x9C471E7D, void>(_FireHandle, _TargetFillPercent); }
	static void FIRE_SET_GROW_RATE(FireHandle_t _FireHandle, float _GrowRate) { Invoke<0x1A82B949, void>(_FireHandle, _GrowRate); }
	static void FIRE_SET_DECAY_RATE(FireHandle_t _FireHandle, float _DecayRate) { Invoke<0x7906A950, void>(_FireHandle, _DecayRate); }
	static void FIRE_SET_EXPIRE_ALLOWED(FireHandle_t _FireHandle, bool _AllowExpire) { Invoke<0x6471D75C, void>(_FireHandle, _AllowExpire); }
